...
export class TableFileRowViewModel extends TableRowViewModel {
  constructor(args: ITableRowViewModelCreateOptions, fileControl: FileListViewModel) {
    ...
    this.draggable = !Platform.isFirefox && !Platform.isMacOsSafari && !Platform.isMobile();
  }
  ...
  public initialize(cells: ReadonlyMap<string, ITableCellViewModel>): void {
  ...
  public onDragStart(e: React.DragEvent): void {
    const url = this.fileViewModel.getDownloadUrl();
