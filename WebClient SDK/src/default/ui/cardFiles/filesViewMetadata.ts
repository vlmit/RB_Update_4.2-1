...
export class FilesViewMetadata {
  static create(): IViewMetadata {
    ...
    viewMetadata.autoSelectFirstRow = false;
    viewMetadata.defaultSortColumns = [new SortingColumn('Caption')];
  ...
  private static addDefaultColumns(viewMetadata: ViewMetadata) {
    const groupNameColumn = new ViewColumnMetadata();
    groupNameColumn.caption = 'GroupName';
    groupNameColumn.alias = 'GroupName';
    groupNameColumn.schemeType = SchemeType.NullableString;
    groupNameColumn.hidden = true;
    ...
    groupCaptionColumn.hidden = true;
    ...
    const appearanceColumn = new ViewColumnMetadata();
    appearanceColumn.alias = 'Appearance';
    appearanceColumn.schemeType = SchemeType.String;
    appearanceColumn.hidden = true;

    viewMetadata.appearance = appearanceColumn.alias;

    viewMetadata.columns.set(groupNameColumn.alias, groupNameColumn);
    ...
    viewMetadata.columns.set(appearanceColumn.alias, appearanceColumn);
  }
