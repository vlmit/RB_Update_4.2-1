...
export class StageSelectorViewModel {
  ...
  constructor(group: StageGroup | null, cardId: string, typeId: string) {
    this.group = group;
    this.cardId = cardId;
    this.typeId = typeId;
    this.groups = [];
  ...
  private _typesCache: Map<string, StageType[]>;
  ...
  @action.bound
  public async updateType(): Promise<void> {
  ...
  @action.bound
  public setSelectedGroupIndex(index: number): void {
    this.selectedGroupIndex = index;
  }

  @action.bound
  public setSelectedTypeIndex(index: number): void {
