...
export interface IFilterViewDialogDescriptorRegistry {
   ...
   *
   * Значение расположено в TessaAdmin на вкладке "Рабочие места" в окне "Свойства" в поле "Id". К данному элементу дерева должно быть применено расширение Tessa.Extensions.Default.Client.Views.OverrideFilterViewExtension.
...
export class FilterViewDialogDescriptorRegistry implements IFilterViewDialogDescriptorRegistry {
  ...
  private readonly _descriptors: Map<string, FilterViewDialogDescriptor> = new Map<
    string,
