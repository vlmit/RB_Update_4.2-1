...
export class WorkplaceCardEditorInitializeExtension extends ApplicationExtension {
  async initialize(): Promise<void> {
    ComponentsRegistry.instance.register(WorkplaceCardEditorViewModel, WorkplaceCardEditor);
  }
}
...
export class WorkplaceCardEditorViewModel extends BaseContentItem {
  ...
  async refresh(): Promise<void> {
    ...
    if (!cardId) {
      await this.cardEditor.setCardModel(null);
    }
...
export const WorkplaceCardEditor = observer<WorkplaceCardEditorProps>(
  function WorkplaceCardEditor(props) {
