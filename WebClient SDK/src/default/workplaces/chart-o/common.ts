import type { ScaleOrdinal, ScaleSequential } from 'd3';
...
export const colorFunc = (
  ...
  data: DataType,
  palette: string
): ScaleOrdinal<string, unknown> => colorFuncOrdinal(d3, data, palette);

export const colorFuncOrdinal = (
  d3: D3Type,
  _data: DataType,
  palette: string
...
export const colorFuncSequential = (
  d3: D3Type,
  data: DataType,
  _palette: string
