...
/** File version extension that adds menu action "Temp link". */
@extension({ name: 'TempLinkFileVersionExtension' })
export class TempLinkFileVersionExtension extends FileVersionExtension {
  //#region ctor
