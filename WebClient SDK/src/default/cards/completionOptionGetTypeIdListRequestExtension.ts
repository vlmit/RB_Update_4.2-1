...
import { CardResponse, CardRequestTypes } from 'tessa/cards/service';
import { extension } from '@tessa/application';

@extension()
export class CompletionOptionGetTypeIdListRequestExtension extends CardRequestExtension {
  public shouldExecute(context: ICardRequestExtensionContext): boolean {
    return context.requestType === CardRequestTypes.GetTypeIDList;
  }
