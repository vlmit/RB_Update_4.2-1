...
import { CardFilesDataProvider } from '../ui/cardFiles/cardFilesDataProvider';
import { AbCustomCardFilesDataProvider } from './abCustomCardFilesDataProvider';
import { FilesViewCardControlInitializationStrategy } from '../ui/cardFiles/filesViewCardControlInitializationStrategy';

/**
 * Custom strategy that provide customized data for files in view.
 */
export class AbCustomFilesViewCardControlInitializationStrategy extends FilesViewCardControlInitializationStrategy {
  /**
  ...
  protected createDataProvider(
    ...
    context;
    return new AbCustomCardFilesDataProvider(viewMetadata, fileControl);
  }
}
