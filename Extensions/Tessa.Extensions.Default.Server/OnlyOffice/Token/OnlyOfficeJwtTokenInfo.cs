...
namespace Tessa.Extensions.Default.Server.OnlyOffice.Token
{
    ...
    public sealed partial class OnlyOfficeJwtTokenInfo :
        ValidationStorageObject
    {
        ...
        public string? OnlyOfficeUrl
        {
            get
            {
                var payload = this.TryGet<string>("payload");
                return payload is not null
                    ? JsonConvert.DeserializeObject<OnlyOfficeInternalJWT>(payload)?.url
                    : null;
            }
        }
