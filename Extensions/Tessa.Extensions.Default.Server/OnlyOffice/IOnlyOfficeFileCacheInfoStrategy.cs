...
namespace Tessa.Extensions.Default.Server.OnlyOffice
{
    ...
    public interface IOnlyOfficeFileCacheInfoStrategy
    {
        ...
        /// Значение <c>null</c> аналогично пустому списку.
        /// </summary>
        /// <param name="fileVersionIDs">Идентификаторы версии для совместного редактирования</param>
        /// <param name="cancellationToken">Объект, посредством которого можно отменить асинхронную задачу.</param>
        /// <returns>Список записей по совместному редактированию. Значение <c>null</c> аналогично пустому списку.</returns>
        ValueTask<List<OnlyOfficeCurrentCoedit>?> TryGetCurrentCoeditInfosAsync(IEnumerable<Guid>? fileVersionIDs, CancellationToken cancellationToken = default);
    }
}
