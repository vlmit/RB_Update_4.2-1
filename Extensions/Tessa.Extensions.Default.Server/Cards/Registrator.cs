...
using Tessa.Extensions.Default.Server.Cards.UserPalettesSettings;
using Tessa.Extensions.Default.Server.Cards.Word;
    ...
    public sealed class Registrator : RegistratorBase
    {
        public override void RegisterUnity()
        {
            this.UnityContainer
                ...
                .RegisterType<IWordDocumentParser, WordDocumentParser>(new ContainerControlledLifetimeManager())
                .RegisterType<IWordDocumentParsingRuleResolver, WordDocumentParsingRuleResolver>(new ContainerControlledLifetimeManager())
                .RegisterType<IWordDocumentMoveProcessor, WordDocumentMoveProcessor>(new ContainerControlledLifetimeManager())
                .RegisterType<WordDocumentConditionalBlockStartParsingRule>(new ContainerControlledLifetimeManager())
                .RegisterType<WordDocumentConditionalBlockEndParsingRule>(new ContainerControlledLifetimeManager())
                .RegisterType<WordDocumentTableGroupBlockBookmarkStartParsingRule>(new ContainerControlledLifetimeManager())
                .RegisterType<WordDocumentTableGroupBlockBookmarkEndParsingRule>(new ContainerControlledLifetimeManager())
                .RegisterType<WordDocumentTableGroupBlockCommentStartParsingRule>(new ContainerControlledLifetimeManager())
                .RegisterType<WordDocumentTableGroupBlockCommentEndParsingRule>(new ContainerControlledLifetimeManager())
                .RegisterType<WordDocumentPlaceholdersParagraphRule>(new ContainerControlledLifetimeManager())
                .RegisterType<WordDocumentPlaceholdersHyperlinkRule>(new ContainerControlledLifetimeManager())
                .RegisterType<WordDocumentPlaceholdersFieldCodeRule>(new ContainerControlledLifetimeManager())
                .RegisterType<WordDocumentAutoTableGroupParagraphRule>(new ContainerControlledLifetimeManager())
                .RegisterType<WordDocumentAutoTableGroupTableRowRule>(new ContainerControlledLifetimeManager())
                ...
                .RegisterType<TagsGetExtension>(new ContainerControlledLifetimeManager())
                ...
                .RegisterType<HelpSectionPermissionsGetExtension>(new ContainerControlledLifetimeManager())
                .RegisterType<UserPalettesSettingsGetExtension>(new ContainerControlledLifetimeManager())
                .RegisterType<UserPalettesSettingsStoreExtension>(new ContainerControlledLifetimeManager())
                .RegisterType<ICycleGroupingSettings, CycleGroupingSettings>(new ContainerControlledLifetimeManager())
                ;
        }
        ...
        public override void RegisterExtensions(IExtensionContainer extensionContainer)
        {
            ...
            extensionContainer
                .RegisterExtension<ICardGetExtension, CardPermissionsGetExtension>(x => x
                    .WithOrder(ExtensionStage.BeforePlatform, 1)
                    .WithSingleton())
                .RegisterExtension<ICardGetExtension, HelpSectionPermissionsGetExtension>(x => x
                    .WithOrder(ExtensionStage.AfterPlatform, 2)
                    .WithUnity(this.UnityContainer)
                    .WhenCardTypes(CardHelper.HelpSectionTypeID))
                ...
                .RegisterExtension<ICardGetExtension, KrPersonalRolesNewGetExtension>(x => x
                    ...
                    .WithUnity(this.UnityContainer)
                    .WhenCardTypes(RoleHelper.PersonalRoleTypeID))
                .RegisterExtension<ICardGetExtension, TagsGetExtension>(x => x
                ...
                .RegisterExtension<ICardGetExtension, KrGetTaskForTasksEditorGetExtension>(x => x
                    ...
                    .WithUnity(this.UnityContainer)
                    .WhenAnyCardType())
                .RegisterExtension<ICardGetExtension, UserPalettesSettingsGetExtension>(x => x
                    .WithOrder(ExtensionStage.AfterPlatform, 21)
                    .WithUnity(this.UnityContainer)
                    .WhenCardTypes(RoleHelper.PersonalRoleTypeID))
                ;
            ...
            // Store
            extensionContainer
                .RegisterExtension<ICardStoreExtension, KrClearClientCardInfoStoreExtension>(x => x
                ...
                .RegisterExtension<ICardStoreExtension, CardPermissionsStoreExtension>(x => x
                    .WithOrder(ExtensionStage.BeforePlatform, 1)
                    .WithSingleton())
                .RegisterExtension<ICardStoreExtension, UserPalettesSettingsStoreExtension>(x => x
        ...
        public override void FinalizeRegistration()
        {
            ...
            this.UnityContainer
                .TryResolve<IWordDocumentParsingRuleResolver>()?
                .RegisterRule<CommentRangeStart, WordDocumentConditionalBlockStartParsingRule>()
                .RegisterRule<CommentRangeEnd, WordDocumentConditionalBlockEndParsingRule>()
                .RegisterRule<CommentRangeStart, WordDocumentTableGroupBlockCommentStartParsingRule>()
                .RegisterRule<CommentRangeEnd, WordDocumentTableGroupBlockCommentEndParsingRule>()
                .RegisterRule<BookmarkStart, WordDocumentTableGroupBlockBookmarkStartParsingRule>()
                .RegisterRule<BookmarkEnd, WordDocumentTableGroupBlockBookmarkEndParsingRule>()
                .RegisterRule<Paragraph, WordDocumentPlaceholdersParagraphRule>()
                .RegisterRule<Hyperlink, WordDocumentPlaceholdersHyperlinkRule>()
                .RegisterRule<FieldCode, WordDocumentPlaceholdersFieldCodeRule>()
                .RegisterRule<Paragraph, WordDocumentAutoTableGroupParagraphRule>()
                .RegisterRule<TableRow, WordDocumentAutoTableGroupTableRowRule>()
                ;
        }
    }
}
