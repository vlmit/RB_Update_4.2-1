...
namespace Tessa.Extensions.Default.Server.Cards
{
    ...
    public sealed class SaveFileTemplateOnCardStoreExtension : CardStoreExtension
    {
        ...
        private const string SaveWithFileTemplateKey = StorageHelper.SystemKeyPrefix + "SaveWithFileTemplate";
        private const string SaveWithFileTemplateResponseKey = StorageHelper.SystemKeyPrefix + "SaveWithFileTemplateResponse";
        ...
        {
            if (context.Session.Token?.ApplicationID != ApplicationIdentifiers.WebClient ||
                GetFileTemplateDataFromInfo(context.Request.TryGetInfo()) == null)
            {
        ...
        public override async Task BeforeCommitTransaction(ICardStoreExtensionContext context)
        {
            ...
            if (context.Session.Token?.ApplicationID != ApplicationIdentifiers.WebClient
                ...
                || (fileTemplateData = GetFileTemplateDataFromInfo(context.Request.TryGetInfo())) == null)
            {
                return;
            }
