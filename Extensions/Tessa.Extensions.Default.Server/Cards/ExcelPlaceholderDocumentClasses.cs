...
namespace Tessa.Extensions.Default.Server.Cards
{
    ...
    public static class ExcelHelper
    {
        ...
        /// </summary>
        public static readonly IList<IPlaceholder> EmptyPlaceholders = ImmutableList<IPlaceholder>.Empty;
        ...
        public static void NotSupported(string operation, string objectType)
        {
            throw new NotSupportedException(
                string.Format(LocalizeName("KrMessages_ExcelTemplate_OperationNotSupported"),
                    operation,
                    objectType));
        }
    ...
    public sealed class WorksheetElement : ElementBase<Worksheet>
    {
        ...
        {
            ExcelHelper.NotSupported(nameof(this.Clone), nameof(WorksheetElement));
            return null;
        }
        ...
        {
            ExcelHelper.NotSupported(nameof(this.Insert), nameof(TableGroup));
        }
        ...
        {
            ExcelHelper.NotSupported(nameof(this.Remove), nameof(WorksheetElement));
        }
        ...
        public override void Update()
        {
            ...
            if (this.Element.Elements<SheetData>().FirstOrDefault() is { } rowData)
            {
    ...
    public sealed class TableGroup : CellsGroup<DefinedName>
    {
        ...
        {
            ExcelHelper.NotSupported(nameof(this.Clone), nameof(TableGroup));
            return null;
        }
        ...
        public override void Update()
        {
            ExcelHelper.NotSupported(nameof(this.Update), nameof(TableGroup));
        }

        public override string GetDisplayString()
        {
            return string.Format(
                LocalizeName("KrMessages_ExcelTemplate_DefineNameDisplayFormat"),
                this.Name,
                this.Worksheet.Name,
                this.Reference);
        }
        ...
        private void ParseDefineName(string text)
        {
            ...
            {
                this.IsValid = false;
                this.ErrorText = string.Format(LocalizeName("KrMessages_ExcelTemplate_DefineNameParsingError"), this.Name);
                return;
            }
            if (matches.Count > 1)
            {
                this.IsValid = false;
                this.ErrorText = string.Format(LocalizeName("KrMessages_ExcelTemplate_DefineNameRangesError"), this.Name);
                return;
            }
        ...
        private void AddTableToTables(IList<TableGroup> tables, TableGroup parentTable = null)
        {
            ...
            else
            {
                ...
                foreach (MergeCellGroup mergeCell in this.Worksheet.MergeCells)
                {
                    ...
                    {
                        this.IsValid = false;
                        this.ErrorText = string.Format(LocalizeName("KrMessages_ExcelTemplate_DefineNameCrossesMergeCell"),
