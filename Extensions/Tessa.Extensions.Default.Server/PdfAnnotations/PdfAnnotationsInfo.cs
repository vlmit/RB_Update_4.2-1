...
{
    public class PdfAnnotationsInfo : StorageSerializable
    {
        #region Properties 

        public PdfAnnotationsAction? Action { get; set; }

        public PdfAnnotationsData? Data { get; set; }
        ...
        protected override void DeserializeCore(Dictionary<string, object?> storage)
        {
            ...
            this.Data = TryGetObject<PdfAnnotationsData>(storage, nameof(this.Data));
        }
