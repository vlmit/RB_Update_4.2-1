...
{
    /// <summary>
    /// Расширение для процесса отправки уведомления мобильного согласования по заданиям, удовлетворяющим условию <see cref="WfHelper.TaskTypeIsResolution(Guid)"/>.
    /// </summary>
    /// <param name="cardCache"><inheritdoc cref="CardCache" path="/summary"/></param>
    public class ResolutionMobileApprovalNotificationSendExtension(ICardCache cardCache) : MobileApprovalNotificationSendExtensionBase
    {
        #region Properties
            ...
            context.NotificationEmail.BodyTemplate = bodyTemplate
                .Replace(
                    ...
                    $"""
                     ...
                     <br/>
                     <p>{CreateMobileApprovalLink(task.RowID, mobileApprovalEmail, "{$KrMessages_TaskCompleteLink}")}</p>
                     <br/>
