...
namespace Tessa.Extensions.Default.Server.Workflow.KrObjectModel
{
    public class StageSettingsConverter : IStageSettingsConverter
    {
            ...
            CancellationToken cancellationToken = default)
        {
            ...
            var serializerSettings = await this.serializer.GetSettingsAsync(cancellationToken);

            var fields = serializerSettings.SettingsFieldNames;
            ...
            var settingsSections = serializerSettings.SettingsSectionNames;
