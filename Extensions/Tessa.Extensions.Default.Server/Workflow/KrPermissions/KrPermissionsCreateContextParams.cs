...
namespace Tessa.Extensions.Default.Server.Workflow.KrPermissions
{
    ...
    public sealed class KrPermissionsCreateContextParams
    {
        ...
        /// <summary>
        /// Метод для дополнительной валидации предыдущего токена или <c>null</c>, если дополнительная валидация токена не требуется.
        /// </summary>
        public Action<KrToken, IValidationResultBuilder>? CustomValidationAction { get; set; }

        /// <summary>
        /// <inheritdoc cref="CardServiceType" path="/summary"/>
        /// <para/>
        /// При значении, отличном от <see cref="CardServiceType.Default"/>, токен <see cref="PrevToken"/> с установленным флагом <see cref="KrToken.ServerOnly"/> игнорируется.
        /// </summary>
