...
namespace Tessa.Extensions.Default.Server.Workflow.KrPermissions
{
    ...
    public interface IKrPermissionsManagerResult
    {
        ...
        /// </summary>
        IReadOnlyCollection<Guid> SubmittedRules { get; }

        /// <summary>
        /// Список правил доступа, которые были отклонены при расчёте прав доступа.
        /// </summary>
        IReadOnlyCollection<Guid> RejectedRules { get; }
