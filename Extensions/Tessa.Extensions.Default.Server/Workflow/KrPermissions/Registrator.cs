    ...
    public sealed class Registrator : RegistratorBase
    {
        public override void RegisterUnity()
        {
            this.UnityContainer
                ...
                .RegisterSingleton<IViewInterceptor, KrPermissionsFlagsViewInterceptor>(nameof(KrPermissionsFlagsViewInterceptor))

                // Расширяет представление по правилам доступа
                .RegisterSingleton<IViewInterceptor, KrPermissionsViewInterceptor>(nameof(KrPermissionsViewInterceptor))
        ...
        public override void InitializeExtensions(IExtensionContainer extensionContainer)
        {
            extensionContainer
                .RegisterType<ICardPermissionsExtension>(x => x
                    ...
                    .MethodAsync<IKrPermissionsManagerContext>(y => y.ExtendPermissionsBeforeTokenCheckAsync)
                    .MethodAsync<IKrPermissionsManagerContext>(y => y.ExtendPermissionsAfterTokenCheckAsync),
