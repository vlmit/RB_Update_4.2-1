...
namespace Tessa.Extensions.Default.Server.Workflow.KrPermissions
{
    ...
    {
        public static KrCardTaskTypePermissionFilterPolicy Instance { get; } = new();
        ...
        public ValueTask<object> GetFilterContextAsync(
            ...
            new(extensionContext is ITaskPermissionsExtensionContext context ? context.TaskType : null);
            ...
            object filterContext)
        {
            ...
            {
                return new(policy.IsAllowed(cardType));
            }
