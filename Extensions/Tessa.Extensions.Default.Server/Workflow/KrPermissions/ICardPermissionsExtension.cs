...
namespace Tessa.Extensions.Default.Server.Workflow.KrPermissions
{
    ...
    {
        /// <summary>
        /// Метод, расширяющий права на карточку, выполняющийся до применения прав из KrToken.
        /// </summary>
        /// <param name="context">
        /// Контекст расширения прав доступа.
        /// </param>
        /// <returns>Асинхронная задача.</returns>
        Task ExtendPermissionsBeforeTokenCheckAsync(IKrPermissionsManagerContext context);

        /// <summary>
        /// Метод, расширяющий права на карточку, выполняющийся после применения прав из KrToken.
        /// </summary>
        /// <param name="context">
        /// Контекст расширения прав доступа.
        /// </param>
        /// <returns>Асинхронная задача.</returns>
        Task ExtendPermissionsAfterTokenCheckAsync(IKrPermissionsManagerContext context);
