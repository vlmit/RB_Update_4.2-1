...
namespace Tessa.Extensions.Default.Server.Workflow.KrPermissions.Files
{
    ...
    {
        /// <summary>
        /// Сессия пользователя, для которого производится проверка прав доступа к файлу.
        /// </summary>
        ISession Session { get; }

        /// <summary>
        /// Карточка, к которой прикреплен файл, или <see langword="null"/>.
        /// </summary>
        Card? Card { get; }

        /// <summary>
        /// Идентификатор карточки, к которой прикреплен файл, или <see langword="null"/>.
        /// </summary>
        Guid? CardId { get; }

        /// <summary>
        /// Идентификатор типа документа для карточки, к которой прикреплен файл, или <see langword="null"/>.
        /// </summary>
        Guid? DocTypeId { get; }
        ...
        /// </summary>
        KrPermissionsFileAccessSettingFlag RequiredAccessFlags { get; }
        ...
        /// <summary>
        /// Флаг показывает, выполняется ли проверка доступа серверной операции или операции с клиента.
        /// </summary>
        bool ServerOperation { get; }
        ...
        /// <summary>
        /// Текущий проверяемый файл или <see langword="null"/>, если проверка файла выполняется по его идентификатору <see cref="FileID"/>.
        /// </summary>
        CardFile? File { get; }
        ...
        /// <summary>
        /// Идентификатор проверяемой версии файла или <see langword="null"/>, если проверка выполняется без конкретной версии.
        /// </summary>
        Guid? VersionID { get; }

        /// <summary>
        /// Текущий сохраняемый файл или <see langword="null"/>, если проверка выполняется без учёта изменений файла.
        /// </summary>
