...
namespace Tessa.Extensions.Default.Server.Workflow.KrPermissions
{
    ...
    public interface IKrPermissionsManager
    {
        ...
        /// <summary>
        /// Метод для создания контекста проверки прав доступа. Метод формирует контекст прав доступа с учетом полученных данных.
        /// Если при создании контекста возникли ошибки, то они запишутся в результат валидации, переданный через <see cref="KrPermissionsCreateContextParams.ValidationResult"/>.
        /// </summary>
        /// <param name="param">
        ...
        /// <returns>Результат создания контекста проверки прав доступа.</returns>
        Task<KrPermissionsCreateContextResult> TryCreateContextAsync(
