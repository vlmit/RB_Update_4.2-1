...
namespace Tessa.Extensions.Default.Server.Workflow.KrCompilers
{
        ...
        IExtraSourceSerializer
    {
        ...
        private readonly JsonSerializer jsonSerializer = TessaSerializer.CreateTyped(TessaSerializer.CreateDefaultSettings(utcDates: false), sealConverter: true);
            ...
            IList<IExtraSource> list)
        {
            ...
            using (var jsonWriter = new OptimizedJsonTextWriter(sw))
            {
