...
namespace Tessa.Extensions.Default.Server.Workflow.KrCompilers
{
    public static class KrCompilersExtensions
    {
        ...
        /// <returns>Созданный экземпляр объекта <see cref="IKrScript"/> или значение <see langword="null"/>, если произошла ошибка или сценарий не задан.</returns>
        ...
        public static string ToStringSummary(this Stage stage, int spaces = 0)
        {
            ...
            sb.Append(Localize(stage.StageTypeCaption));
            sb.Append(' ');
            sb.Append(stage.Name);
            sb.Append('(');
            if (stage.BasedOnTemplate)
            {
                sb.Append(LocalizeName("CardTypes_TypesNames_KrStageTemplate"));
                sb.Append(" \"");
                sb.Append(stage.TemplateName);
                sb.Append("\", ");
            }

            sb.Append(LocalizeName("CardTypes_TypesNames_KrStageGroup"));
            sb.Append(" \"");
        ...
        public static string ToStringSummary(this Performer performer, int spaces = 0)
        {
            ...
            return $"{Indent(spaces)}{performer.PerformerID} {Localize(performer.PerformerName)}";
        }
