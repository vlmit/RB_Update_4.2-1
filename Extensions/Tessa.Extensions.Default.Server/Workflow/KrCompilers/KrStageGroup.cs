...
namespace Tessa.Extensions.Default.Server.Workflow.KrCompilers
{
        ...
        IKrStageGroup
    {
        ...
        /// <inheritdoc />
        public bool HasSource => !string.IsNullOrWhiteSpace(this.SourceCondition)
            || !string.IsNullOrWhiteSpace(this.SourceBefore)
            || !string.IsNullOrWhiteSpace(this.SourceAfter)
            || !string.IsNullOrWhiteSpace(this.RuntimeSourceCondition)
