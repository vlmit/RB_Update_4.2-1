...
namespace Tessa.Extensions.Default.Server.Workflow.KrCompilers
{
    ...
    public interface IKrProcessCache
    {
        ...
        ValueTask<IReadOnlyDictionary<Guid, IKrStageGroup>> GetAllStageGroupsAsync(
        ...
        ValueTask<IReadOnlyList<IKrStageGroup>> GetOrderedStageGroupsAsync(
            CancellationToken cancellationToken = default);
        ...
        ValueTask<IReadOnlyDictionary<Guid, IKrStageTemplate>> GetAllStageTemplatesAsync(
            CancellationToken cancellationToken = default);
        ...
        ValueTask<IReadOnlyDictionary<Guid, IKrRuntimeStage>> GetAllRuntimeStagesAsync(
            CancellationToken cancellationToken = default);

        /// <summary>
        /// Возвращает коллекцию, содержащую информацию о этапах, расположенных в шаблонах этапов.
        /// </summary>
        /// <param name="cancellationToken">Объект, посредством которого можно отменить выполнение асинхронной задачи.</param>
        /// <returns>Словарь, содержащий информацию о всех этапах, расположенных в шаблонах этапов. Ключ - идентификатор шаблона этапа. Значение - коллекция этапов, расположенных в шаблоне этапов.</returns>
        ValueTask<IReadOnlyDictionary<Guid, IReadOnlyList<IKrRuntimeStage>>> GetAllStagesByTemplatesAsync(
            CancellationToken cancellationToken = default);
        ...
        ValueTask<IReadOnlyList<IKrCommonMethod>> GetAllCommonMethodsAsync(
            CancellationToken cancellationToken = default);
        ...
        ValueTask<IReadOnlyDictionary<Guid, IKrPureProcess>> GetAllPureProcessesAsync(
            CancellationToken cancellationToken = default);
        ...
        ValueTask<IReadOnlyDictionary<Guid, IKrAction>> GetAllActionsAsync(
            CancellationToken cancellationToken = default);
        ...
        ValueTask<IReadOnlyDictionary<Guid, IKrProcessButton>> GetAllButtonsAsync(
            CancellationToken cancellationToken = default);
