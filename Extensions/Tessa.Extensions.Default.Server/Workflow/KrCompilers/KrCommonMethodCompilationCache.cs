...
namespace Tessa.Extensions.Default.Server.Workflow.KrCompilers
{
        ...
        IKrCommonMethodCompilationCache
    {
            ...
            CancellationToken cancellationToken = default)
        {
            ...
            {
                return new TessaCompilationContext<IKrCompilationContext>(id)
                {
                    ValidationResult = this.CreateSourceObjectNotFoundValidationResult(id),
                };
            }
            ...
            if (commonMethods.Any(static i => i.HasSource))
            {
            ...
            CancellationToken cancellationToken = default)
        {
            ...
            // Всегда компилируем все объекты, т.к. они могут ссылаться друг на друга.
            var hasSources = commonMethods.Any(static i => i.HasSource);
