...
namespace Tessa.Extensions.Default.Server.Workflow.KrCompilers
{
        ...
        IKrSecondaryProcess
    {
        ...
        /// <param name="executionSqlCondition">Текст SQL запроса, определяющий доступность выполнения.</param>
            ...
            string executionSourceCondition)
        {
            ...
            this.ContextRolesIDs = contextRolesIDs.ToImmutableList();

            this.HasSource = !string.IsNullOrWhiteSpace(this.ExecutionSourceCondition);
        }
