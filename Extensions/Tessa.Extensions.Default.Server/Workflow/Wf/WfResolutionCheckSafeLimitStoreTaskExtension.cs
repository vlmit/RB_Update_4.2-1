    ...
    public class WfResolutionCheckSafeLimitStoreTaskExtension : CardStoreTaskExtension
    {
        ...
        public override async Task StoreTaskBeforeCommitTransaction(ICardStoreTaskExtensionContext context)
        {
                ...
                objStoreDateTime is not null)
            {
                ...
                DateTime utcParentPlanned = parentPlanned.ToUniversalTime();
        ...
        /// прибавить смещение <paramref name="offset"/>,
            ...
            CancellationToken cancellationToken = default)
        {
            if (positiveDurationOnly && plannedWorkingDays <= 0)
            {
                validationResult.AddError(this,
                    ...
                    FormatDoubleAsDecimal(plannedWorkingDays, 1));
                ...
                if (!result.HasValue)
                {
                    validationResult.AddError(this,
                        ...
                        FormatDateTimeWithoutSeconds(
                            ...
                            convertToLocal: false),
                        FormatDateTimeWithoutSeconds(initialDateTime, convertToLocal: false),
                        FormatDoubleAsDecimal(plannedWorkingDays, 1));
                }
