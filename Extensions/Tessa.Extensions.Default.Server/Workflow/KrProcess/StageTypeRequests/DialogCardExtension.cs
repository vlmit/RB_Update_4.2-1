...
{
    /// <summary>
    /// Расширение на запуск маршрута. Устанавливает флаг, отменяющий закрытие диалога, если обработка диалога была прервана в сценарии диалога.
    /// </summary>
    public sealed class DialogCardExtension :
