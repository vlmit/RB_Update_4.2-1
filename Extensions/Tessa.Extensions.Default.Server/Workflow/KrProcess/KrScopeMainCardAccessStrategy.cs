...
namespace Tessa.Extensions.Default.Server.Workflow.KrProcess
{
    ...
    public sealed class KrScopeMainCardAccessStrategy: IMainCardAccessStrategy
    {
            ...
            CancellationToken cancellationToken = default)
        {
            ...
            return this.scope.GetMainCardAsync(
                this.cardID,
            ...
            CancellationToken cancellationToken = default)
        {
            ...
            return await this.scope.GetMainCardFileContainerAsync(
                this.cardID,
        ...
        /// <inheritdoc />
        public Task EnsureTasksLoadedAsync(
            IValidationResultBuilder validationResult = null,
            CancellationToken cancellationToken = default)
        {
            if (!this.WasUsed)
            ...
            return this.scope.EnsureTasksLoadedAsync(this.cardID, validationResult ?? this.result, cancellationToken);
        }
