...
namespace Tessa.Extensions.Default.Server.Workflow.KrProcess
{
        ...
        RegistratorBase
    {
        ...
        {
            this.UnityContainer
                .RegisterSingleton<IKrStageSerializerSettingsCache, KrStageSerializerSettingsCache>()
                .RegisterSingleton<IKrStageSerializer, KrStageSerializer>()
                .RegisterSingleton<IKrStageRowChecker, KrStageRowChecker>()
                .RegisterSingleton<IWorkflowProcessRunner, KrRoutesProcessRunner>(nameof(WorkflowProcessTypes.KrProcess))
                ;
            ...
            this.UnityContainer
                .RegisterType<KrCardMetadataExtension>(
                    ...
                    new InjectionConstructor(
                        ...
                        typeof(IKrStageSerializerSettingsCache)))
                .RegisterSingleton<KrSecondaryProcessMetadataExtension>()
                ;

            this.UnityContainer
                .RegisterSingleton<IKrTokenProvider, KrTokenProvider>()
                .RegisterSingleton<ICardServerPermissionsProvider, KrCardServerPermissionsProvider>()
                .RegisterSingleton<ICardTaskAccessProvider, KrCardTaskAccessProvider>()
                .RegisterSingleton<IKrTypesCache, KrTypesCache>(
                    new InjectionConstructor(
                        typeof(IDbScope),
                        typeof(ICardMetadata),
                        typeof(ICardCache),
                        typeof(IUnityDisposableContainer)))
                .RegisterSingleton<IKrSecondaryProcessTileHandlerResolver, KrSecondaryProcessTileHandlerResolver>()
                .RegisterSingleton<IViewInterceptor, KrSecondaryProcessTileHandlersViewInterceptor>(
                    nameof(KrSecondaryProcessTileHandlersViewInterceptor))
                ;

            this.UnityContainer
                .RegisterSingleton<KrSetDefaultSettingsValuesGetExtension>()
                .RegisterSingleton<KrSetTemplateDocTypeNewExtension>()
                .RegisterSingleton<KrDocTypeInvalidateSettingsCacheStoreExtension>()
                .RegisterSingleton<KrDocTypeInvalidateSettingsCacheDeleteExtension>()
                .RegisterSingleton<KrGetDocTypesCardExtension>()
                .RegisterSingleton<KrCreateBasedOnNewExtension>()
                .RegisterSingleton<KrUniversalTaskSettingsStoreExtension>()
                .RegisterSingleton<KrAcquaintanceSettingsStoreExtension>()
                .RegisterSingleton<KrStrictSecurityCardNewGetExtension>()
                .RegisterSingleton<KrStrictSecurityCardStoreExtension>()
                .RegisterSingleton<KrStrictSecurityCardDeleteExtension>()
                .RegisterSingleton<KrStagesImportExtension>()
                ;

            this.UnityContainer
                .RegisterSingleton<PartnersCardMetadataExtension>(
                    new InjectionConstructor(typeof(IDbScope)))
                ;

            this.UnityContainer
                .RegisterSingleton<KrSettingsInvalidateTypeCacheStoreExtension>(
                    new InjectionConstructor(
            ...
            this.UnityContainer
                .RegisterSingleton<KrSettingsInvalidateTypeCacheDeleteExtension>(
                    new InjectionConstructor(
                        typeof(CardMetadataCache),
                        typeof(IKrTypesCache),
                        typeof(ISession)))
        ...
        public override void RegisterExtensions(IExtensionContainer extensionContainer)
        {
            ...
            extensionContainer
                ...
                .RegisterExtension<ICardStoreExtension, KrUniversalTaskSettingsStoreExtension>(x => x
                    .WithOrder(ExtensionStage.BeforePlatform)
                    .WithUnity(this.UnityContainer))
                .RegisterExtension<ICardGetExtension, KrUniversalTaskOptionsGetExtension>(x => x
                    .WithOrder(ExtensionStage.AfterPlatform, 99)
                    .WithSingleton()
                    .WhenAnyCardType())
