...
namespace Tessa.Extensions.Default.Server.Workflow.KrProcess.Workflow
{
    ...
    public sealed class WorkflowAPIBridge :
        IWorkflowAPIBridge
    {
        #region Fields
        ...
        {
            var task = await this.AddNewTaskAsync(
                taskTypeID,
                roleID,
                roleName,
                null,
            ...
            return await this.manager.AddTaskAsync(
                task,
                this.processInfo,
                taskParameters,
                cancellationToken);
        ...
        /// <inheritdoc />
        public async ValueTask AddActiveTaskAsync(
            Guid taskID,
            IValidationResultBuilder validationResult,
            CancellationToken cancellationToken = default)
        {
        ...
        public ValueTask<bool> TryRemoveActiveTaskAsync(
            ...
            IValidationResultBuilder validationResult,
            CancellationToken cancellationToken = default) =>
            this.RemoveActiveTaskInternalAsync(
                taskID,
                false,
                validationResult,
                cancellationToken);
        ...
        /// <inheritdoc />
        public async ValueTask RemoveActiveTaskAsync(
            Guid taskID,
            IValidationResultBuilder validationResult,
            CancellationToken cancellationToken = default) =>
            await this.RemoveActiveTaskInternalAsync(
                taskID,
                true,
                validationResult,
                cancellationToken);
        ...
        /// <inheritdoc />
        public async ValueTask<IReadOnlyList<Guid>> GetActiveTasksAsync(
            IValidationResultBuilder validationResult,
            CancellationToken cancellationToken = default)
        {
        ...
        /// <inheritdoc />
        public ValueTask InitCounterAsync(
            int counterNumber,
            int initialValue,
            CancellationToken cancellationToken = default) =>
            this.manager.InitCounterAsync(
                counterNumber,
                this.processInfo,
                initialValue,
                cancellationToken);
        ...
        public ValueTask<WorkflowCounterState> DecrementCounterAsync(
            ...
            CancellationToken cancellationToken = default) =>
            this.manager.DecrementCounterAsync(
                counterNumber,
                this.processInfo,
                decrementValue,
                cancellationToken);
        ...
        /// <inheritdoc />
        public ValueTask<bool> RemoveCounterAsync(
            int counterNumber,
            CancellationToken cancellationToken = default) =>
            this.manager.RemoveCounterAsync(
                counterNumber,
                this.processInfo,
                cancellationToken);
            ...
            CancellationToken cancellationToken = default)
        {
            ...
            var newResponse = await this.manager
                .WorkflowContext
