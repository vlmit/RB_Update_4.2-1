        ...
        : StageTypeHandlerBase
    {
        ...
        public class ScriptContext
        {
                ...
                CancellationToken cancellationToken = default)
            {
                ...
                return await this.tasksRevoker.RevokeTaskAsync(new StageTaskRevokerContext(
                    this.context,
                ...
                CancellationToken cancellationToken = default)
            {
                ...
                return await this.tasksRevoker.RevokeTasksAsync(new StageTaskRevokerContext(
                    this.context,
                    this.context.ValidationResult,
                    cancellationToken)
                {
        ...
        protected IKrStageTemplateCompilationCache CompilationCache { get; } = NotNullOrThrow(compilationCache);
        ...
        public override async Task<bool> HandleStageInterruptAsync(IStageTypeHandlerContext context) =>
            await this.TasksRevoker.RevokeAllStageTasksAsync(
        ...
        protected async Task<StageHandlerResult> CompleteStageAsync(IStageTypeHandlerContext context)
        {
            ...
            await using (this.DbScope.Create())
            {
                ...
                await this.TasksRevoker.RevokeAllStageTasksAsync(new StageTaskRevokerContext(
                    context,
                    context.ValidationResult,
                    context.CancellationToken));
                return StageHandlerResult.InProgressResult;
