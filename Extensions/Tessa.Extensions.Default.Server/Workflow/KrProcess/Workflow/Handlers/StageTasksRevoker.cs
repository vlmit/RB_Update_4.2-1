...
namespace Tessa.Extensions.Default.Server.Workflow.KrProcess.Workflow.Handlers
{
    ...
    /// </summary>
    public sealed class StageTasksRevoker :
        IStageTasksRevoker
    {
        #region Fields
        ...
        /// <inheritdoc />
        public async Task<bool> RevokeTaskAsync(
            ...
            CardTask task)
        {
            ...
            {
                await context.Context.WorkflowAPI.TryRemoveActiveTaskAsync(
                    task.RowID,
