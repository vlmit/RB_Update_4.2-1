    ...
    public sealed class Registrator : RegistratorBase
    {
        public override void RegisterUnity()
        {
            this.UnityContainer
                ...
                .RegisterType<ApprovalProcessStageTypeHandler>(new ContainerControlledLifetimeManager())
                .RegisterType<ApprovalProcessManagementStageTypeHandler>(new ContainerControlledLifetimeManager())
        ...
        public override void FinalizeRegistration()
        {
            this.UnityContainer
                ...
                .RegisterHandler<ApprovalProcessStageTypeHandler>(StageTypeDescriptors.ApprovalProcessDescriptor)
                .RegisterHandler<ApprovalProcessManagementStageTypeHandler>(StageTypeDescriptors.ApprovalProcessManagementDescriptor)
