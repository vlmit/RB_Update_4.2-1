...
namespace Tessa.Extensions.Default.Server.Workflow.KrProcess.Workflow.Handlers
{
    ...
    public class NotificationStageTypeHandler : StageTypeHandlerBase
    {
        ...
        public override async Task<StageHandlerResult> HandleStageStartAsync(IStageTypeHandlerContext context)
        {
            ...
            {
                (_, null) => new IDNotificationRecipientsSourceParameter { Identifiers = roles },
                (0, not null) => new IDNotificationRecipientsSourceParameter { Identifiers = optionalRecipients, IsOptional = true },
                _ => new AggregateNotificationRecipientsSourceParameter
                {
                    Parameters =
                    [
                        new IDNotificationRecipientsSourceParameter { Identifiers = roles },
                        new IDNotificationRecipientsSourceParameter { Identifiers = optionalRecipients, IsOptional = true }
                    ]
                }
            };
            ...
            context.ValidationResult.Add(
                await this.NotificationManager.SendAsync(
                    ...
                    new NotificationSendContext
                    {
                        ...
                        TaskTypeID = context.TaskInfo?.Task.TypeID,
