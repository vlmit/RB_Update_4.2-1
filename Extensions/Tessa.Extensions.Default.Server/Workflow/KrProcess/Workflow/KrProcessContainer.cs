...
namespace Tessa.Extensions.Default.Server.Workflow.KrProcess.Workflow
{
        ...
        IDisposable
    {
        ...
        private readonly AsyncLock taskAsyncLock = new();
        private readonly Lock stageSyncObject = new();
        private readonly Lock signalSyncObject = new();

        /// <summary>
        /// Хендлеры этапов.
        /// </summary>
        private readonly Dictionary<Guid, StageHandlerItem> stageHandlers = new();

        /// <summary>
        /// Хендлеры глобальных сигналов.
        /// </summary>
        private readonly Dictionary<string, List<Type>> globalSignalHandlers = new();

        /// <summary>
        /// Зарегистрированные типы заданий.
        /// </summary>
        private readonly ConcurrentContainer<Guid, object> registeredTaskTypes = new();
        ...
        private readonly HashSet<Guid> stageHandlersToExclude = new();
        private readonly HashSet<string> signalsToExclude = new();
        private readonly HashSet<SignalFilterItem> signalHandlersToExclude = new();
