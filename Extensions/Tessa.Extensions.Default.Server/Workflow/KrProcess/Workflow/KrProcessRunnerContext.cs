...
namespace Tessa.Extensions.Default.Server.Workflow.KrProcess.Workflow
{
    ...
    public sealed class KrProcessRunnerContext :
        IKrProcessRunnerContext
    {
        #region Fields
            ...
            CancellationToken cancellationToken = default)
        {
            ...
            this.ProcessHolder = NotNullOrThrow(processHolder);
            this.ProcessInfo = processInfo;
            this.ValidationResult = NotNullOrThrow(validationResult);
            this.CardContext = cardContext;
            this.DefaultPreparingGroupStrategyFunc = NotNullOrThrow(defaultPreparingGroupStrategyFunc);
            this.ParentProcessTypeName = parentProcessTypeName;
            this.ParentProcessID = parentProcessID;
            this.IsProcessHolderCreated = isProcessHolderCreated;
            this.updateCardFuncAsync = NotNullOrThrow(updateCardFuncAsync);
