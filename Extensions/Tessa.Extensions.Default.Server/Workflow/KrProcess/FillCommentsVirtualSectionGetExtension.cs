        ...
        CardGetExtension
    {
        ...
        public override Task AfterRequest(ICardGetExtensionContext context)
        {
                ...
                x.TypeID == DefaultTaskTypes.KrSigningTypeID))
            {
                ...
                if (!sections.TryGetValue(KrConstants.KrCommentsInfoVirtual.Name, out CardSection commentsVirtual)
                    || !sections.TryGetValue(KrConstants.KrCommentsInfo.Name, out CardSection commentsOriginal)
