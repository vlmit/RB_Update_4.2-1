...
namespace Tessa.Extensions.Default.Server.Workflow.KrProcess
{
        ...
        IKrTokenProvider
    {
        ...
        public virtual KrToken CreateToken(
            ...
            KrPermissionExtendedCardSettingsStorage extendedCardSettings = null,
            Action<KrToken> modifyTokenAction = null)
        {
            ...
            Span<byte> signature = stackalloc byte[this.SignatureProvider.GetSignatureLength()];
            ...
            using (MemoryStream stream = StreamHelper.AcquireMemoryStream(2048))
            {
                ...
                var data = stream.AsSpan();
                this.SignatureProvider.Sign(data, signature);
            }
            ...
            CancellationToken cancellationToken = default)
        {
            ...
            if (tokenCardID != card.ID && !(tokenCardID == Guid.Empty && card.Version == 0))
            {
            ...
            using (MemoryStream stream = StreamHelper.AcquireMemoryStream(2048))
            {
                ...
                verified = this.SignatureProvider.Verify(stream.AsSpan(), signature);
            }
            ...
            if (customValidationAction is not null)
            {
