...
namespace Tessa.Extensions.Default.Server.Workflow.KrProcess.Satellite
{
    ...
    public sealed class Registrator : RegistratorBase
    {
        ...
        public override void FinalizeRegistration()
        {
            ...
            registry.Register(new(DefaultCardTypes.KrSatelliteTypeID)
            {
                HandlerType = typeof(KrSatelliteHandler),
                IsSingleton = true,
                IgnoreGetPrepare = true,
                IgnoreStorePrepare = true,
                CopySatelliteOnCardCopy = true,
                WithoutInstancesTable = true,
            });

            registry.Register(new(DefaultCardTypes.KrSecondarySatelliteTypeID)
            {
