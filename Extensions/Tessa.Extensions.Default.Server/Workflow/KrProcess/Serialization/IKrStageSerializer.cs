...
namespace Tessa.Extensions.Default.Server.Workflow.KrProcess.Serialization
{
    ...
    public interface IKrStageSerializer
    {
        ...
        /// <param name="settingsStorage">Параметры этапа.</param>
        /// <param name="cancellationToken">Объект, посредством которого можно отменить асинхронную задачу.</param>
        /// <returns>Асинхронная задача.</returns>
        ValueTask SerializeSettingsStorageAsync(
            CardRow stageRow,
        ...
        /// <param name="cancellationToken">Объект, посредством которого можно отменить асинхронную задачу.</param>
        /// <returns>Десериализованные параметры этапа.</returns>
        ...
        /// </summary>
        /// <param name="sourceCard">Исходная карточка.</param>
        /// <param name="destinationCard">Карточка назначения.</param>
        /// <param name="predeserializedSettings">Подмножество десериализованных настроек, которое можно использовать вместо явной десериализации из секции.</param>
        /// <param name="hiddenStageMode"><inheritdoc cref="KrProcessSerializerHiddenStageMode" path="/summary"/></param>
        /// <param name="cardContext">Внешний контекст расширения на карточку.</param>
        /// <param name="cancellationToken">Объект, посредством которого можно отменить асинхронную задачу.</param>
        /// <returns>Асинхронная задача.</returns>
        ...
        /// <param name="stageStorages">Коллекция ключ-значение, где ключ - идентификатор строки этапа, значение - параметры этапа.</param>
        ...
        /// <param name="storage">Параметры этапа.</param>
        /// <param name="cancellationToken">Объект, посредством которого можно отменить асинхронную задачу.</param>
        /// <returns>Асинхронная задача.</returns>
        ValueTask FillStageSettingsAsync(
            CardRow row,
