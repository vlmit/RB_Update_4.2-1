...
namespace Tessa.Extensions.Default.Server.Workflow.KrProcess.Serialization
{
        ...
        IExtensionContext
    {
        ...
        /// <summary>
        /// Тип карточки маршрута. Перед сериализацией настроек этапов (<see cref="IKrStageRowExtension.BeforeSerialization(IKrStageRowExtensionContext)"/>) тип <see cref="InnerCard"/>, после десериализации настроек этапов тип <see cref="OuterCard"/>.
        /// </summary>
