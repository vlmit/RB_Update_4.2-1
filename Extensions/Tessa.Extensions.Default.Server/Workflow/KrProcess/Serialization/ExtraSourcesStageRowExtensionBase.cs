...
namespace Tessa.Extensions.Default.Server.Workflow.KrProcess.Serialization
{
    ...
    public abstract class ExtraSourcesStageRowExtensionBase : KrStageRowExtension
    {
        ...
        /// <summary>
        /// Переносит информацию о сценарии этапа, текст тела которого расположен в поле <c>scriptField</c>, в коллекцию содержащую информацию о дополнительных скриптах этапа.
        /// </summary>
