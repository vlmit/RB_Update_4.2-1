...
namespace Tessa.Extensions.Default.Server.Workflow.KrProcess.Requests
{
    public sealed class KrCardNewExtension : CardNewExtension
    {
        ...
        private static void FillApprovalCommonInfoTemplate(Card card)
        {
            ...
            aci.Fields[KrProcessCommonInfo.ProcessOwnerID] = null;
            aci.Fields[KrProcessCommonInfo.ProcessOwnerName] = null;
            aci.Fields[KrApprovalCommonInfo.CurrentHistoryGroup] = null;
            aci.Fields[KrProcessCommonInfo.Info] = null;
            aci.Fields[KrProcessCommonInfo.NestedWorkflowProcesses] = null;
            ...
            fields[KrProcessCommonInfo.MainCardID] = null;
            fields[KrProcessCommonInfo.CurrentApprovalStageRowID] = null;
            fields[KrApprovalCommonInfo.ApprovedBy] = null;
            fields[KrApprovalCommonInfo.DisapprovedBy] = null;
            fields[KrProcessCommonInfo.AuthorID] = null;
            fields[KrProcessCommonInfo.AuthorName] = null;
            fields[KrProcessCommonInfo.ProcessOwnerID] = null;
            fields[KrProcessCommonInfo.ProcessOwnerName] = null;
            fields[KrApprovalCommonInfo.CurrentHistoryGroup] = null;
            fields[KrProcessCommonInfo.Info] = null;
            fields[KrProcessCommonInfo.NestedWorkflowProcesses] = null;
            fields[KrApprovalCommonInfo.AuthorComment] = null;
        }
