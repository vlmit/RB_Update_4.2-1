        ...
        CardNewGetExtension
    {
        ...
        public override async Task AfterRequest(ICardNewExtensionContext context)
        {
            if (context.Request.ServiceType == CardServiceType.Default
                ...
                || !context.Response.Card.Sections.ContainsKey(DocumentCommonInfo.Name))
            {
                return;
            }
            ...
            await using (dbScope.Create())
            {
                ...
                foreach (var group in groups)
                {
                    ...
                    else
                    {
                        ...
                        var groupTile = new KrTileInfo(
                            id: Guid.Empty,
                            name: string.Empty,
                            caption: group.Key,
                            icon: actionGrouping ? null : Ui.DefaultTileGroupIcon,
