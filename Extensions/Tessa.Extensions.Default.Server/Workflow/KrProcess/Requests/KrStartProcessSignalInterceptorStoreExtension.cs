...
namespace Tessa.Extensions.Default.Server.Workflow.KrProcess.Requests
{
        ...
        CardStoreExtension
    {
            ...
            Dictionary<string, object> parameters)
        {
            ...
            var startingProcessID = parameters.TryGet<Guid?>(KrConstants.KrProcessID);

            if (startingProcessID.HasValue)
            {
                request.SetStartingProcessID(startingProcessID.Value);
            }
            ...
            await using (dbScope.Create())
            {
                ...
                return await db
                    .SetCommand(dbScope.BuilderFactory
                        ...
                        .Where().C("aci", KrConstants.KrProcessCommonInfo.MainCardID).Equals().P("CardID")
                        .Build(),
