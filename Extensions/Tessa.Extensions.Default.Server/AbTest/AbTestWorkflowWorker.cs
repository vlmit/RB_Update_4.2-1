...
namespace Tessa.Extensions.Default.Server.AbTest
{
    ...
    /// </summary>
    public sealed class AbTestWorkflowWorker(
        IWorkflowManager manager,
        ICardRepository cardRepositoryToCreateTasks)
        : WorkflowTaskWorker<IWorkflowManager>(manager, cardRepositoryToCreateTasks)
    {
            ...
            CancellationToken cancellationToken = default)
        {
            ...
            {
                case AbTestProcessHelper.MainSubProcess:
                ...
                case AbTestProcessHelper.SubProcess1:
                    await this.RenderStepAsync(1, processInfo, cancellationToken);
                    break;
            ...
            CancellationToken cancellationToken = default)
        {
            ...
            if (typeID == AbTaskTypes.AbTask1TypeID)
            {
            ...
            else if (typeID == AbTaskTypes.AbTask2TypeID)
            {
                // Тип2
            ...
            CancellationToken cancellationToken = default)
        {
            ...
            switch (signalInfo.ProcessTypeName)
            {
                case AbTestProcessHelper.MainSubProcess:
                    ...
                    {
                        case AbTestProcessHelper.TestSignal:
                    ...
                    switch (transitionNumber)
                    {
                        ...
                        case 2:
                            await this.StartSubProcessWithCompletionAsync(
                                AbTestProcessHelper.SubProcess1, 4, processInfo, cancellationToken: cancellationToken);
                            break;
                        ...
                        case 5:
                            await this.StartSubProcessWithCompletionAsync(
                                AbTestProcessHelper.SubProcess1, 6, processInfo, cancellationToken: cancellationToken);
                            break;
