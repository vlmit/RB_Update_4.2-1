...
{
    /// <summary>
    /// Настройки плагина <see cref="DefaultPluginNames.FileConverterRemoveCachePlugin"/>.
    /// </summary>
    /// <inheritdoc cref="PluginSettings(string)"/>
    /// <param name="settings">Глобальные настройки конфигурации.</param>
    public sealed class FileConverterRemoveCachePluginSettings(string name, Dictionary<string, object?> settings)
        : PluginSettings(name)
    {
        #region Fields
