...
namespace Tessa.Extensions.Default.Shared
{
    ...
    public static class DefaultNotifications
    {
        ...
        /// <summary>
        /// Уведомление о невозможности обработать входящее письмо.
        /// </summary>
        public static Guid UnableToProcessMessageNotification = new Guid(0x290a43db, 0xd5db, 0x4b31, 0x97, 0x2c, 0x16, 0xe2, 0xb3, 0x6a, 0x7e, 0x41); // 290a43db-d5db-4b31-972c-16e2b36a7e41
    }
}
