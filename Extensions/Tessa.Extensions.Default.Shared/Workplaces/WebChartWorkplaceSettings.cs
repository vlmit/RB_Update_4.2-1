...
namespace Tessa.Extensions.Default.Shared.Workplaces
{
        ...
        StorageSerializable
    {
        ...
        protected override void SerializeCore(Dictionary<string, object> storage)
        {
            ...
            storage[nameof(this.LegendItemMinWidth)] = Int32Boxes.Box(this.LegendItemMinWidth);
            storage[nameof(this.ColumnCount)] = Int32Boxes.Box(this.ColumnCount);
            storage[nameof(this.LegendNotWrap)] = BooleanBoxes.Box(this.LegendNotWrap);
            storage[nameof(this.DoesntShowZeroValues)] = BooleanBoxes.Box(this.DoesntShowZeroValues);
        ...
        {
            this.DiagramType = storage.TryConvertEnum<WebChartDiagramType>(nameof(this.DiagramType)) ?? WebChartDiagramType.Bar;
            this.DiagramDirection = storage.TryConvertEnum<WebChartDiagramDirection>(nameof(this.DiagramDirection)) ?? WebChartDiagramDirection.Horizontal;
            this.LegendPosition = storage.TryConvertEnum<WebChartLegendPosition>(nameof(this.LegendPosition)) ?? WebChartLegendPosition.Bottom;
