...
namespace Tessa.Extensions.Default.Shared
{
    public static class DefaultRequestTypes
    {
        ...
        /// Расширение цифровой подписи
        /// </summary>
        public static readonly Guid PdfAnnotations = // C1EED776-AA5E-4117-BC1A-4453FD3AD1C1
            new Guid(0xc1eed776, 0xaa5e, 0x4117, 0xbc, 0x1a, 0x44, 0x53, 0xfd, 0x3a, 0xd1, 0xc1);

        /// <summary>
        /// Запрос на генерацию нового TOTP-кода для двухфакторной аутентификации.
        /// </summary>
        public static readonly Guid GenerateTwoFactorAuthTotpCode = // {D9C5D25B-D1F8-487A-B317-8DE42980DBD8}
            new Guid(0xd9c5d25b, 0xd1f8, 0x487a, 0xb3, 0x17, 0x8d, 0xe4, 0x29, 0x80, 0xdb, 0xd8);

        /// <summary>
        /// Получение секрета для использования JWT в OnlyOffice/Р7
        /// </summary>
        public static readonly Guid OnlyOfficeJWTSecretRequest =  // {0DAE1A5C-28E2-4D5C-AAAB-4291608A0DF1}
            new(0x0dae1a5c, 0x28e2, 0x4d5c, 0xaa, 0xab, 0x42, 0x91, 0x60, 0x8a, 0x0d, 0xf1);

        /// <summary>
        /// Обогащение цифровых подписей до архивного формата.
        /// </summary>
        public static readonly Guid SignaturesArchiveRequest = // 6C13426F-AB71-4128-8D64-6591E467BBCF
            new(0x6c13426f, 0xab71, 0x4128, 0x8d, 0x64, 0x65, 0x91, 0xe4, 0x67, 0xbb, 0xcf);
