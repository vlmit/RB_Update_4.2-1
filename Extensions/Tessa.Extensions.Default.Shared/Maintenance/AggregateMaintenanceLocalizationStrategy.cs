...
namespace Tessa.Extensions.Default.Shared.Maintenance
{
    ...
    /// </summary>
    public sealed class AggregateMaintenanceLocalizationStrategy(Func<IEnumerable<IMaintenanceLocalizationStrategy>> getStrategiesFunc)
        : MaintenanceLocalizationStrategyBase
    {
        #region Fields

        private readonly Func<IEnumerable<IMaintenanceLocalizationStrategy>> getStrategiesFunc = NotNullOrThrow(getStrategiesFunc);
