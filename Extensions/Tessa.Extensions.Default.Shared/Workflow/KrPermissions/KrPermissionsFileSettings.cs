...
namespace Tessa.Extensions.Default.Shared.Workflow.KrPermissions
{
    ...
    public sealed partial class KrPermissionsFileSettings : CardStorageObject
    {
        #region Constructors
        ...
        /// <summary>
        /// Настройка доступа на создание временной ссылки для файла.
        /// </summary>
        public int? CreateLinkAccessSetting
        {
            get => this.TryGet<int?>(nameof(this.CreateLinkAccessSetting));
            set => this.Set(nameof(this.CreateLinkAccessSetting), Int32Boxes.Box(value));
        }
