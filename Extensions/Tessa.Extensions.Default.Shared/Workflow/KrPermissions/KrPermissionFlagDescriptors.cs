...
{
    /// <summary>
    /// Список стандартных флагов настроек прав доступа.
    /// </summary>
    public static class KrPermissionFlagDescriptors
    {
        ...
        /// <summary>
        /// Создание ссылки на скачивание файла/версии.
        /// </summary>
        public static readonly KrPermissionFlagDescriptor CreateFileLink = new(
            new Guid(0x3C96DBD0, 0x86B5, 0x473B, 0xB3, 0x0A, 0x89, 0x9C, 0x28, 0x85, 0x19, 0xA3), // 3C96DBD0-86B5-473B-B30A-899C288519A3
            "CreateFileLink",
            42,
            "$KrPermissions_CreateFileLink",
            "$CardTypes_Controls_CreateFileLink",
            "$CardTypes_Controls_CreateFileLink_Tooltip",
            "CanCreateFileLink");
        ...
        /// </summary>
        public static readonly KrPermissionFlagDescriptor RestoreAllDeletedFiles = new KrPermissionFlagDescriptor(
            new Guid(0x17D1C55E, 0xB7C8, 0x4219, 0x96, 0x14, 0x9C, 0x38, 0xED, 0xE0, 0x1A, 0x73), // 17D1C55E-B7C8-4219-9614-9C38EDE01A73
            "RestoreAllDeletedFiles",
            52,
            "$KrPermissions_RestoreAllDeletedFiles",
            "$CardTypes_Controls_RestoreAllDeletedFiles",
            null,
            "CanRestoreAllDeletedFiles",
            AddFiles);
        ...
        public static readonly KrPermissionFlagDescriptor ModifyOwnTaskAssignedRoles = new KrPermissionFlagDescriptor(
            ...
            "$CardTypes_Controls_ModifyOwnTaskAssignedRoles_Tooltip",
        ...
        public static readonly KrPermissionFlagDescriptor ModifyAllTaskAssignedRoles = new KrPermissionFlagDescriptor(
            ...
            "$CardTypes_Controls_ModifyAllTaskAssignedRoles_Tooltip",
            "CanModifyAllTaskAssignedRoles",
            ModifyOwnTaskAssignedRoles);

        /// <summary>
        /// Возможность редактирования схемы согласования.
        /// </summary>
        public static readonly KrPermissionFlagDescriptor EditApprovalScheme = new KrPermissionFlagDescriptor(
            new Guid(0x4e9525f1, 0xc4a8, 0x47fd, 0xa9, 0x12, 0x67, 0xa3, 0x68, 0x9f, 0x39, 0x76), // {4E9525F1-C4A8-47FD-A912-67A3689F3976}
            "EditApprovalScheme",
            59,
            "$KrPermissions_EditApprovalScheme",
            "$CardTypes_Controls_EditApprovalScheme",
            "$CardTypes_Controls_EditApprovalScheme_Tooltip",
            "CanEditApprovalScheme");

        /// <summary>
        /// Возможность упоминания пользователей в обсуждениях.
        /// </summary>
        public static readonly KrPermissionFlagDescriptor CanMentionNewUsers = new KrPermissionFlagDescriptor(
            new Guid(0x1596f17a, 0x9560, 0x48ac, 0x8a, 0xdf, 0x74, 0xc7, 0x48, 0x61, 0x22, 0xb9), // {1596F17A-9560-48AC-8ADF-74C7486122B9}
            "CanMentionNewUsers",
            88,
            "$KrPermissions_CanMentionNewUsers",
            "$CardTypes_Controls_ForumCanMentionNewUsers",
            "$CardTypes_Controls_ForumCanMentionNewUsers_Tooltip",
            "CanMentionNewUsers");

        /// <summary>
        /// Все доступные флаги.
        /// </summary>
        public static readonly IReadOnlyList<KrPermissionFlagDescriptor> FullCardPermissionsGroupFlags =
            new List<KrPermissionFlagDescriptor>
            {
                ReadCard,
                EditCard,
                AddFiles,
        ...
        public static readonly KrPermissionFlagDescriptor FullCardPermissionsGroup = new KrPermissionFlagDescriptor(
            ...
            FullCardPermissionsGroupFlags);

        /// <summary>
        /// Полный перечень всех прав доступа.
        /// </summary>
        /// <seealso cref="FullCardPermissionsGroupFlags"/>
        ...
        /// <summary>
        /// Возвращает флаг с перечнем всех флагов прав доступа.
        /// </summary>
