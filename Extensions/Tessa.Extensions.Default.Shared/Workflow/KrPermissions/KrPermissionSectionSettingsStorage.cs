...
namespace Tessa.Extensions.Default.Shared.Workflow.KrPermissions
{
    ...
    public sealed partial class KrPermissionSectionSettingsStorage : CardStorageObject, IKrPermissionSectionSettings
    {
        #region Nested Types
        ...
        {
            get => this.TryGet<IReadOnlyCollection<Guid>>(nameof(this.AllowedFields)) ?? ImmutableList<Guid>.Empty;
        ...
        {
            get => this.TryGet<IReadOnlyCollection<Guid>>(nameof(this.DisallowedFields)) ?? ImmutableList<Guid>.Empty;
        ...
        {
            get => this.TryGet<IReadOnlyCollection<Guid>>(nameof(this.HiddenFields)) ?? ImmutableList<Guid>.Empty;
        ...
        {
            get => this.TryGet<IReadOnlyCollection<Guid>>(nameof(this.VisibleFields)) ?? ImmutableList<Guid>.Empty;
        ...
        {
            get => this.TryGet<IReadOnlyCollection<Guid>>(nameof(this.MandatoryFields)) ?? ImmutableList<Guid>.Empty;
        ...
        {
            get => this.TryGet<IReadOnlyCollection<Guid>>(nameof(this.MaskedFields)) ?? ImmutableList<Guid>.Empty;
