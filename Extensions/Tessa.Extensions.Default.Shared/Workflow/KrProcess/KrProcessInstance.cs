...
namespace Tessa.Extensions.Default.Shared.Workflow.KrProcess
{
    ...
    public sealed partial class KrProcessInstance : StorageObject
    {
        ...
        /// <param name="serializedProcess">Сериализованная объектная модель процесса.</param>
        /// <param name="serializedProcessSignature">Подпись <paramref name="serializedProcess"/>.</param>
        public KrProcessInstance(
            Guid processID,
            Guid? cardID,
            string? serializedProcess,
            byte[]? serializedProcessSignature)
            : base(new Dictionary<string, object?>(StringComparer.Ordinal))
        {
            ...
            this.Init(nameof(this.SerializedProcess), serializedProcess);
            this.Init(nameof(this.SerializedProcessSignature), serializedProcessSignature);
        }
        ...
        /// <param name="parentProcessTypeName">Имя типа родительского процесса.</param>
        ...
        /// <param name="nestedOrder">Порядковый номер вложенного процесса.</param>
        public KrProcessInstance(
            Guid processID,
            Guid? cardID,
        ...
        /// </summary>
        public IDictionary<string, object?> ProcessInfo => this.Get<IDictionary<string, object?>>(nameof(this.ProcessInfo), () => new Dictionary<string, object?>(StringComparer.Ordinal));
