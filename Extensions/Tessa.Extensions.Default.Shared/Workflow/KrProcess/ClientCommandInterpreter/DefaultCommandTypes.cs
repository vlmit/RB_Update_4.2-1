...
namespace Tessa.Extensions.Default.Shared.Workflow.KrProcess.ClientCommandInterpreter
{
    ...
    public static class DefaultCommandTypes
    {
        ...
        /// <item>
        ///     <description><see cref="KrConstants.Keys.CompletionOptionSettings"/></description>
        ///     <description>Хранилище объекта типа <see cref="CardTaskCompletionOptionSettings"/> сохранённое по ключу <see cref="WorkflowTaskAndDialogActionBase.DialogSettingsKey"/> в коллекции ключ-значение получаемое для данного параметра</description>
        ///     <description>Параметры диалога.</description>
        /// </item>
        /// </list>
        /// </remarks>
