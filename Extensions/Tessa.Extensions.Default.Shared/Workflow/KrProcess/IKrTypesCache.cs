...
namespace Tessa.Extensions.Default.Shared.Workflow.KrProcess
{
    ...
    public interface IKrTypesCache
    {
        ...
        /// <summary>
        /// Словарь компонентов типового решения для каждого типа карточек и типов документов, используемых в типовом решении.
        /// Возвращаемое значение не равно <c>null</c>.
        /// </summary>
        /// <param name="cancellationToken">Объект, посредством которого можно отменить асинхронную задачу.</param>
        /// <returns>Асинхронная задача.</returns>
        ValueTask<IReadOnlyDictionary<Guid, KrComponents>> GetKrComponentsAsync(CancellationToken cancellationToken = default);
