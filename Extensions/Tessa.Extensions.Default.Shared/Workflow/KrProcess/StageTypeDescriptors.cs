...
namespace Tessa.Extensions.Default.Shared.Workflow.KrProcess
{
    ...
    public static class StageTypeDescriptors
    {
        ...
        /// <summary>
        /// Дескриптор типа этапа "Процесс согласования".
        /// </summary>
        public static readonly StageTypeDescriptor ApprovalProcessDescriptor =
            StageTypeDescriptor.Create(static b =>
            {
                b.ID = new Guid(0x5081cb17, 0xa827, 0x4122, 0xbf, 0xea, 0x21, 0xee, 0x20, 0x98, 0xca, 0x6f);
                b.Caption = "$KrStages_ApprovalProcess";
                b.DefaultStageName = "$KrStages_ApprovalProcess";
                b.SettingsCardTypeID = new Guid(0xaec5bf06, 0x17b2, 0x4141, 0xab, 0xa7, 0x2a, 0xfd, 0xf2, 0xd4, 0x2a, 0x76);
                b.PerformerUsageMode = PerformerUsageMode.None;
                b.SupportedModes.Add(KrProcessRunnerMode.Async);
                b.CanBeSkipped = true;
            });

        /// <summary>
        /// Дескриптор типа этапа "Управление процессом согласования".
        /// </summary>
        public static readonly StageTypeDescriptor ApprovalProcessManagementDescriptor =
            StageTypeDescriptor.Create(static b =>
            {
                b.ID = new (// {60D087EE-6BCB-413F-B8AF-F91C67FAAF2C}
                    0x60d087ee, 0x6bcb, 0x413f, 0xb8, 0xaf, 0xf9, 0x1c, 0x67, 0xfa, 0xaf, 0x2c);
                b.Caption = "$KrStages_ApprovalProcessManagement";
                b.DefaultStageName = "$KrStages_ApprovalProcessManagement";
                b.SettingsCardTypeID = new (// {FFB6FF7A-1D95-4BB5-BA12-B66961F0E2C3}
                    0xffb6ff7a, 0x1d95, 0x4bb5, 0xba, 0x12, 0xb6, 0x69, 0x61, 0xf0, 0xe2, 0xc3);
                b.PerformerUsageMode = PerformerUsageMode.None;
                b.SupportedModes.AddRange([KrProcessRunnerMode.Async, KrProcessRunnerMode.Sync]);
                b.CanBeSkipped = true;
                b.CanBeHidden = true;
            });
    }
