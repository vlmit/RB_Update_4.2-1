...
namespace Tessa.Extensions.Default.Shared.Workflow.KrProcess.Formatters
{
    ...
    /// </summary>
    public sealed class SigningStageTypeFormatter :
        StageTypeFormatterBase
    {
            ...
            IStageTypeFormatterContext context)
        {
            ...
            context.DisplaySettings = context.StageRow.TryGet<bool>(KrConstants.KrSigningStageSettingsVirtual.IsParallel)
            ...
            IStageTypeFormatterContext context)
        {
            ...
            context.DisplaySettings = context.Settings!.TryGet<bool>(KrConstants.KrSigningStageSettingsVirtual.IsParallel)
                ? "$UI_KrApproval_Parallel"
                : "$UI_KrApproval_Sequential";
        }
