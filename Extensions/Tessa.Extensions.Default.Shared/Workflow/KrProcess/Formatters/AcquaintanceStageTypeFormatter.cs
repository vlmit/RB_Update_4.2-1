...
namespace Tessa.Extensions.Default.Shared.Workflow.KrProcess.Formatters
{
    ...
    /// </summary>
    public sealed class AcquaintanceStageTypeFormatter :
        StageTypeFormatterBase
    {
            ...
            IStageTypeFormatterContext context)
        {
            ...
            context.DisplaySettings = context.StageRow.Fields.Get<bool>(KrConstants.KrAcquaintanceSettingsVirtual.ExcludeDeputies)
            ...
            IStageTypeFormatterContext context)
        {
            ...
            context.DisplayTimeLimit = string.Empty;
            context.DisplaySettings = context.Settings!.TryGet<bool>(KrConstants.KrAcquaintanceSettingsVirtual.ExcludeDeputies)
                ? "$UI_KrAcquaintance_ExcludeDeputies"
                : string.Empty;
        }
