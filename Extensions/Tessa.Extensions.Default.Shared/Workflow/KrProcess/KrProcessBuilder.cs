...
namespace Tessa.Extensions.Default.Shared.Workflow.KrProcess
{
    ...
    public sealed class KrProcessBuilder
    {
        ...
        /// <summary>
        /// Устанавливает идентификатор карточки, в которой должен быть запущен процесс.
        /// </summary>
        ...
        /// </summary>
        /// <returns>Объект <see cref="KrProcessBuilder"/> для создания цепочки.</returns>
        public static KrProcessBuilder CreateProcess() => new();
        ...
        /// <returns>Объект <see cref="KrProcessBuilder"/> для создания цепочки.</returns>
        public static KrProcessBuilder ModifyProcess(KrProcessInstance instance) => new(instance);
