...
{
    /// <summary>
    /// Модель для хранения информации о подписи, после успешной подписи в мобильном приложении.
    /// </summary>
    public sealed class SignedDataResult : StorageSerializable
    {
        ...
        protected override void DeserializeCore(Dictionary<string, object?> storage)
        {
            ...
            this.Type = storage.ConvertEnum<SignatureType>(nameof(this.Type));
            this.Profile = storage.ConvertEnum<SignatureProfile>(nameof(this.Profile));
        }
