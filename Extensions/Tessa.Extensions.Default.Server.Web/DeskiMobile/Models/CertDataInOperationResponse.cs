...
{
    /// <summary>
    /// Модель для хранения информации о сертификате подписи, после успешной подписи в мобильном приложении.
    /// </summary>
    public sealed class CertDataInOperationResponse : StorageSerializable
    {
        ...
        protected override void DeserializeCore(Dictionary<string, object?> storage)
        {
            ...
            this.SerialNumber = storage.TryGet<string>(nameof(this.SerialNumber));
            this.IssuerName = storage.TryGet<string>(nameof(this.IssuerName));
            this.ValidFrom = storage.TryGet<string>(nameof(this.ValidFrom));
            this.ValidTo = storage.TryGet<string>(nameof(this.ValidTo));
            this.Certificate = storage.TryGet<string>(nameof(this.Certificate));
            this.Thumbprint = storage.TryGet<string>(nameof(this.Thumbprint));
            this.Comment = storage.TryGet<string>(nameof(this.Comment));
        }
