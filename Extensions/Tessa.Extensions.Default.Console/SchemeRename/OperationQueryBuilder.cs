...
namespace Tessa.Extensions.Default.Console.SchemeRename
{
        ...
        IQueryBuilder
    {
        ...
        public IQueryBuilder Append(char value)
        {
            this.builder.Append(value);
            this.OnAppended();
            return this;
        ...
        public IQueryBuilder Append(IFormatProvider? provider, [InterpolatedStringHandlerArgument("", nameof(provider))] ref AppendInterpolatedStringProviderHandler handler)
        {
            // executed after already appended to string builder
            this.OnAppended();
            return this;
        ...
        void IQueryBuilder.Return()
        {
            // Нет необходимости куда либо возвращать StringBuilder
        }
