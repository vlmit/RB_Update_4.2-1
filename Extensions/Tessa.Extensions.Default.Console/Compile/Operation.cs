...
namespace Tessa.Extensions.Default.Console.Compile
{
    public sealed class Operation(
        ...
        IClientCompilationCacheContainer clientCompilationCacheContainer)
        : ConsoleOperation<OperationContext>(logger, sessionManager, extendedInitialization: true)
    {
        #region Fields

        private readonly IClientCompilationCacheContainer clientCompilationCacheContainer = NotNullOrThrow(clientCompilationCacheContainer);
            ...
            CancellationToken cancellationToken = default)
        {
            ...
            var registeredCategories = await this.clientCompilationCacheContainer.GetRegisteredCategoriesAsync(
                validationResult,
                cancellationToken);
            ...
            CancellationToken cancellationToken = default)
        {
            ...
            {
                var validationResult = new ValidationResultBuilder();
                await this.clientCompilationCacheContainer.RebuildAsync(
