...
namespace Tessa.Extensions.Default.Console.ManageRoles
{
    ...
    public enum CommandType
    {
        ...
        /// <summary>
        /// Пересчёт умных ролей для всех генераторов умных ролей.
        /// </summary>
        [LocalizableDescription("Common_CLI_ManageRoles_RecalcAllSmartRoleGenerators")]
        RecalcAllSmartRoleGenerators,
        
        /// <summary>
        /// Пересчёт умных ролей для указанных генераторов умных ролей.
        /// </summary>
        [LocalizableDescription("Common_CLI_ManageRoles_RecalcSmartRoleGenerators")]
        RecalcSmartRoleGenerators
    }
}
