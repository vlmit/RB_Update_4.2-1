...
namespace Tessa.Extensions.Default.Console.DeleteCards
{
        ...
        ConsoleOperation<OperationContext>
    {
            ...
            CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                ...
                for (int i = 0; i < cardInfoList.Count; i++)
                {
                    ...
                    CardDeleteResponse response = await this.DeleteCardCoreAsync(cardInfo.CardID, cardTypeID, deleteWithBackup, cancellationToken);
        ...
        private async Task<CardDeleteResponse> DeleteCardCoreAsync(
            Guid cardID,
            Guid? cardTypeID,
            bool deleteWithBackup,
            CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                var request = new CardDeleteRequest
                {
                    ...
                    DeletionMode = deleteWithBackup ? CardDeletionMode.WithBackup : CardDeletionMode.WithoutBackup,
                };
        ...
        public override async Task<int> ExecuteAsync(OperationContext context, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                ...
                if (!await this.DeleteCardsAsync(context.CardInfoList, context.IgnoreAlreadyDeleted, context.DeleteWithBackup, cancellationToken))
                {
                    return -1;
                }
            }
