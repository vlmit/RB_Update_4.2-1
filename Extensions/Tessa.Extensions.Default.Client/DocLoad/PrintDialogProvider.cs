...
namespace Tessa.Extensions.Default.Client.DocLoad
{
        ...
        IPrintDialogProvider
    {
            ...
            CancellationToken cancellationToken = default)
        {
            ...
            Card settingsCard = (await this.cardCache.Cards.GetAsync(CardHelper.DocLoadTypeName, cancellationToken)).GetValue();
            ...
            if (showHeader)
            {
                ...
                {
                    Text = await LocalizeNameAsync("CardTypes_TypesNames_DocLoad"),
                    FontSize = 27,
                ...
                {
                    Text = string.Format(await LocalizeNameAsync("CardTypes_Controls_DocLoad_DocNumber"), digest),
                    FontSize = 20,
                    Margin = new Thickness(96)
                };
