...
namespace Tessa.Extensions.Default.Client.Workflow.Wf
{
        ...
        IWfResolutionVisualizationGenerator
    {
           ...
           INode node)
        {
            ...
            string kindCaption = await LocalizeFormatAsync(context.HistoryItem.KindCaption);
            ...
            if (isCompleted)
            {
                ...
                string completed =
                    ...
                    + string.Format(
                        ...
                        FormatDateTimeWithoutSeconds(context.HistoryItem.Completed));
            ...
            else
            {
                ...
                string plannedDateTime = FormatDateTimeWithoutSeconds(context.HistoryItem.Planned);
                string planned =
                    Environment.NewLine
                    ...
                    string inProgressString =
                        ...
                        + string.Format(
                            ...
                            calendarID.HasValue
                                ...
                                : null,
                            FormatDateTimeWithoutSeconds(context.HistoryItem.InProgress.GetValueOrDefault()));
            ...
            string created =
                ...
                + string.Format(
                    ...
                    FormatDateTimeWithoutSeconds(context.HistoryItem.Created));
            ...
            if (isCompleted)
            {
                string planned =
                    ...
                    + string.Format(
                        ...
                        FormatDateTimeWithoutSeconds(context.HistoryItem.Planned));
            ...
            string roleName =
                ...
                + string.Format(
                    ...
                    await LocalizeFormatAsync(context.HistoryItem.Settings.TryGet<string>(TaskHistorySettingsKeys.PerformerName)));
            ...
            string comment =
                await LocalizeFormatAsync(
                    string.IsNullOrEmpty(historyResult) ? TryGetCommentFromTask(context) : historyResult);
        ...
        private static string? TryGetCommentFromTask(IWfResolutionVisualizationContext context)
        {
            ...
            return string.IsNullOrEmpty(parentComment)
                ? null
                : string.Format(LocalizeAndEscapeFormat("$WfResolution_Result_ParentComment"), LocalizationManager.EscapeIfLocalizationString(parentComment));
        }
