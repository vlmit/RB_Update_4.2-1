    ...
    public sealed class Registrator : RegistratorBase
    {
        ...
        public override void RegisterUnity()
        {
            this.UnityContainer
                ...
                .RegisterType<OpenStageSettingsOnDoubleClickExtension>(new ContainerControlledLifetimeManager())
                ;
        }
        ...
        public override void RegisterExtensions(IExtensionContainer extensionContainer)
        {
            extensionContainer
                ...
                .RegisterExtension<ICardStoreExtension, RemoveTagsCardStoreExtension>(x => x
        ...
        public override void FinalizeRegistration()
        {
            this.UnityContainer
                ...
                .Register(typeof(OpenStageSettingsOnDoubleClickExtension))
                .RegisterConfiguratorType(
                    typeof(OpenStageSettingsOnDoubleClickExtension),
                    type => this.UnityContainer.Resolve<OpenStageSettingsOnDoubleClickExtensionConfigurator>())
                ;
        }
    }
}
