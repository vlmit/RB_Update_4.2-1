...
{
    /// <summary>
    /// Реализация расширения типа карточки "Список файлов в представлении" для формы диалога.
    /// </summary>
    public sealed class InitializeFilesViewFormUIExtension : FormUIExtension
    {
        ...
        public InitializeFilesViewFormUIExtension(
            ISession session,
        ...
        {
            var uiContext = (IFormUIExtensionContext) NotNullOrThrow(context.ExternalContext);
        ...
        /// <inheritdoc />
        public override async Task Initializing(IFormUIExtensionContext context)
        {
        ...
        /// <inheritdoc />
        public override async Task Initialized(IFormUIExtensionContext context)
        {
            ValidationResult result = await CardHelper
                .ExecuteTypeExtensionsAsync(
                    DefaultCardTypeExtensionTypes.InitializeFilesView,
