    ...
    public class TableFileRowViewModel : ViewControlRowViewModel
    {
        ...
        protected bool UpdateTable()
        {
            if (this.ViewControlViewModel.Table.GroupingColumn != null ||
                ...
                this.ViewControlViewModel.Parameters?.Any(x => this.ViewControlViewModel.Parameters.Metadata.FindByName(x.Name)?.Hidden == false) == true)
            {
        ...
        private void OnGroupPropertyChanged(PropertyChangedEventArgs e)
        {
            this.Data[ColumnsConst.GroupName] = this.FileViewModel.Group.ID;
            this.Data[ColumnsConst.GroupCaption] = this.FileViewModel.Group.Caption;
            if (this.CellsByColumnName.ContainsKey(ColumnsConst.GroupCaption))
            {
                this.CellsByColumnName[ColumnsConst.GroupCaption].SetText(this.FileViewModel.Group.Caption);
            }
        }
        ...
        private void OnCategoryPropertyChanged(PropertyChangedEventArgs e)
        {
            ...
            string category = this.FileViewModel.Model.Category?.Caption ?? Localize("$UI_Cards_FileNoCategory");
        ...
        {
            string size = FormatSize(this.FileViewModel.Model.Size, SizeUnit.Kilobytes) +
                FormatUnit(SizeUnit.Kilobytes);
        ...
        private void OnSignaturePropertyChanged(PropertyChangedEventArgs e)
        {
            ...
            switch (this.FileViewModel.SummarySignatureState)
            {
                ...
                case FileSignatureState.Checked:
                    ...
                    return;
                case FileSignatureState.CheckedWithWarning:
                    signatureTag.Background = ThemeManager.Current.Theme.CreateSolidColorBrush(ThemeProperty.FileSignatureCheckedWithWarning);
                    return;
                        ...
                        case IFileViewModel fileViewModel:
                            switch (propertyChangedEventArgs.PropertyName)
                            {
                                ...
                                case nameof(IFileViewModel.IsSelected):
                                    ...
                                    return true;
                                case nameof(IFileViewModel.Group):
                                    this.instance.OnGroupPropertyChanged(propertyChangedEventArgs);
                                    return true;
