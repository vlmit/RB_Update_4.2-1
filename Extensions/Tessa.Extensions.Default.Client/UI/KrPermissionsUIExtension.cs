...
namespace Tessa.Extensions.Default.Client.UI
{
    ...
    public sealed class KrPermissionsUIExtension : CardUIExtension
    {
        ...
        private sealed class FileRuleRowHandler
        {
            ...
            private IControlViewModel? createLinkControl;
                ...
                ICardModel rowModel)
            {
                if (!rowModel.Controls.TryGet("FileEditAccessSetting", out this.editControl)
                    || !rowModel.Controls.TryGet("FileCreateLinkAccessSetting", out this.createLinkControl)
            ...
            private void UpdateControlsVisibility(bool initializing)
            {
                ...
                switch (readAccessSetting)
                {
                    case KrPermissionsHelper.FileReadAccessSettings.FileNotAvailable:
                        ...
                        this.createLinkControl!.ControlVisibility = System.Windows.Visibility.Collapsed;
                        ...
                        if (!initializing)
                        {
                            ...
                            ClearFileExtendedSetting("CreateLink");
                    ...
                    default:
                        if (!initializing)
                        {
                            ...
                            this.createLinkControl!.ControlVisibility = System.Windows.Visibility.Visible;
                            this.deleteControl!.ControlVisibility = System.Windows.Visibility.Visible;
            ...
            IPlaceholderManager placeholderManager)
        {
            ...
            ThrowIfNull(cardRepairManager);
            ThrowIfNull(cardMetadata);
            ThrowIfNull(typesProvider);
            ThrowIfNull(placeholderManager);
            ...
            bool isReadonly)
        {
            if (model.Controls.TryGet(flag.Name, out var control))
            {
                ...
                section.Fields[flag.SqlName] = isReadonly; // Соответствует value
            }
        }
