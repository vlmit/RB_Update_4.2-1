...
namespace Tessa.Extensions.Default.Client.UI
{
    ...
    /// </summary>
    public sealed class KrCardTasksEditorUIExtension(
        ISession session,
        IUIHost uiHost,
        ...
        : CardUIExtension
    {
        ...
        /// </summary>
        /// <param name="uiContext"><inheritdoc cref="IUIContext" path="/summary"/></param>
        /// <param name="cardModel"><inheritdoc cref="ICardModel" path="/summary"/></param>
        ...
        /// </summary>
        /// <param name="uiContext"><inheritdoc cref="IUIContext" path="/summary"/></param>
        /// <param name="viewControl"><inheritdoc cref="CardViewControlViewModel" path="/summary"/></param>
            ...
            try
            {
                ...
                await TaskAssignedRolesDialogHelper.ShowTaskAssignedRolesEditorDialogAsync(
                    ...
                    getCardTaskFunctionAsync: async () =>
                    {
                        ...
                        KrProcessSharedExtensions.IgnoreButtons(info);
                        WorkflowEngineHelper.IgnoreWorkflowEngineTiles(info);
                    ...
                    trySaveChangesFunctionAsync: async () =>
                    {
                        ...
                        var digest = card?.TryGetDigest();
                        if (!string.IsNullOrWhiteSpace(digest))
                        {
                            storeRequest.Info.SetDigest(digest);
                        }

                        var storeResponse =
                            await this.cardRepository.StoreAsync(storeRequest);
        ...
        /// </summary>
        /// <param name="viewModel"><inheritdoc cref="CardViewControlViewModel" path="/summary"/></param>
        /// <param name="mapping"><inheritdoc cref="ViewMapping" path="/summary"/></param>
