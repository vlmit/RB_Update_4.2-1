        ...
        RegistratorBase
    {
        ...
        public override void RegisterUnity()
        {
            this.UnityContainer
                ...
                .RegisterType<ApprovalProcessUIHandler>(new PerResolveLifetimeManager())
                .RegisterType<ApprovalProcessManagementUIHandler>(new PerResolveLifetimeManager())
                ;
        }
        ...
        public override void FinalizeRegistration()
        {
            this.UnityContainer
                ...
                .RegisterUIHandler<ApprovalProcessUIHandler>(StageTypeDescriptors.ApprovalProcessDescriptor)
                .RegisterUIHandler<ApprovalProcessManagementUIHandler>(StageTypeDescriptors.ApprovalProcessManagementDescriptor)
                ;
        }
    }
}
