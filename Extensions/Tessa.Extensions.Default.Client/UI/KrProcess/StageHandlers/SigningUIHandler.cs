...
namespace Tessa.Extensions.Default.Client.UI.KrProcess.StageHandlers
{
        ...
        StageTypeUIHandlerBase
    {
        ...
        private IBlockViewModel? signFilesOptionsBlock;
        ...
        public override Task Initialize(IKrStageTypeUIHandlerContext context)
        {
                ...
                && flagsBlock.Controls.FirstOrDefault(static i => i.Name == "FlagsTabs") is TabControlViewModel flagsTabsViewModel)
            {
                ...
                this.signFilesOptionsBlock = flagsTabsViewModel
                    .Tabs.FirstOrDefault(static i => i.Name == "CommonSettings")
                    ?.Blocks.FirstOrDefault(static i => i.Name == "StageSignCardFilesOptions");
            }
            ...
            this.ResolveSignFilesControlsVisibility(context.Row.TryGet<bool>(KrConstants.KrSigningStageSettingsVirtual.SignCardFiles));
        ...
        private void OnSettingsFieldChanged(object? sender, CardFieldChangedEventArgs e)
        {
            ...
            if (e.FieldName == KrConstants.KrSigningStageSettingsVirtual.SignCardFiles
                && e.FieldValue is bool signCardFiles)
            {
                this.ResolveSignFilesControlsVisibility(signCardFiles);
            }
        }

        private void ResolveSignFilesControlsVisibility(bool signCardFiles)
        {
            if (this.signFilesOptionsBlock is not null)
            {
                this.signFilesOptionsBlock.BlockVisibility = signCardFiles
                    ? Visibility.Visible 
