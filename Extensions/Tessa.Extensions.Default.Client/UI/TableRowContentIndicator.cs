...
namespace Tessa.Extensions.Default.Client.UI
{
    ...
    public sealed class TableRowContentIndicator
    {
            ...
            string cellFormat = "$KrActions_RowContentIndicatorFormat")
        {
            ...
            ThrowIfNull(columnInfoDict);
            ThrowIfNullOrEmpty(cellFormat);
            ...
            if (control.Columns.All(i => i.Index != columnOrder))
            {
                throw new ArgumentOutOfRangeException(
                    nameof(columnOrder),
                    columnOrder,
                    LocalizeFormat("$KrActions_OutOfRangeColumnOrder", control.Name, columnOrder.ToString()));
            }
        ...
        public void StartTracking()
        {
            ...
            this.control.CellFormatFunc = context =>
            {
                ...
                return LocalizeFormat(this.cellFormat, context.FormattedValue);
            };
        }
