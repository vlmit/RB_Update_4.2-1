    ...
    public sealed class Registrator : RegistratorBase
    {
        public override void RegisterUnity()
        {
            this.UnityContainer
                .RegisterType<TopicsUIExtension>(new PerResolveLifetimeManager(),
                    new InjectionConstructor(typeof(IForumDialogManager)))
                ...
                .RegisterType<TopicUsersForMentionViewExtension>(new ContainerControlledLifetimeManager())
                ;
        }
        ...
        public override void FinalizeRegistration()
        {
            this.UnityContainer
                ...
                .Register(typeof(TopicUsersForMentionViewExtension))
                .RegisterConfiguratorType(
                    typeof(TopicUsersForMentionViewExtension),
                    type => this.UnityContainer.Resolve<TopicUsersForMentionViewExtensionConfigurator>())
                ; 
        }
    }
}
