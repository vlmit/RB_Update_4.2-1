    ...
    public sealed class Registrator : RegistratorBase
    {
        public override void RegisterExtensions(IExtensionContainer extensionContainer)
        {
            ...
            extensionContainer
                ...
                .RegisterExtension<IFileControlExtension, KrCurrentCycleFileControlExtension>(x => x
                    ...
                    .WithSingleton())
                .RegisterExtension<IFileControlExtension, RestoreFileControlExtension>(x => x
        ...
        public override void RegisterUnity()
        {
            this.UnityContainer
                ...
                .RegisterType<RestoreFileControlExtension>(new ContainerControlledLifetimeManager())
                ;
        }
    }
}
