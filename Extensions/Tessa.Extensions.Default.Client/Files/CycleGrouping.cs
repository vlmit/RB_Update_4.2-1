    ...
    public class CycleGrouping : FileGrouping
    {
        ...
        private static string GetCaption(IFileViewModel viewModel)
        {
            ...
            if (origin == null &&
                ...
                cycleObj != null &&
                file.Info.TryGetValue(CycleGroupingHelper.CreatedByNameKey, out object createtByNameObj) &&
                createtByNameObj != null &&
                file.Info.TryGetValue(CycleGroupingHelper.CreatedKey, out object createdObj) &&
                createdObj != null)
            {
                return 
                    LocalizeFormat(
            ...
            if (origin != null)
            {
                return string.Format(
                    LocalizeName("UI_Controls_FilesControl_ByCopy_Format"),
                    file.Name,
                    LocalizeName("UI_Controls_FilesControl_ByCopy_Copy"),
                    file.Versions.Last.CreatedByName,
                    FormatDateTime(file.Versions.Last.Created));
            }
        ...
        {
            if (viewModel.Model.Info.TryGetValue(CycleGroupingHelper.CycleIDKey, out object cycleNumberObj) &&
                cycleNumberObj != null &&
                viewModel.Model.Info.TryGetValue(CycleGroupingHelper.CycleOrderKey, out object cycleOrderObj) &&
                cycleOrderObj != null &&
                viewModel.Model.Info.TryGetValue(CycleGroupingHelper.MaxCycleNumberKey, out object maxCycleNumberObj) &&
                maxCycleNumberObj != null)
            {
                ...
                return new 
                    FileGroupInfo(
                        ...
                        LocalizeFormat("$UI_Controls_FilesControl_CycleGroup", cycleNumberString), 
                        ((int)cycleOrderObj + 1).ToString("D" + length));
            }

            return new FileGroupInfo(DocumentsOnApprovalGroupName, LocalizeName("UI_Controls_FilesControl_DocumentsOnApprovalGroup"), "0");
        }
