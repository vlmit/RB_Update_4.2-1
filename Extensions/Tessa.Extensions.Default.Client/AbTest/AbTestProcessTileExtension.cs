...
namespace Tessa.Extensions.Default.Client.AbTest
{
    ...
    /// </summary>
    public sealed class AbTestProcessTileExtension :
        TileExtension
    {
        ...
        private static async void StartTestProcessActionAsync(object parameters)
        {
            ...
            await editor.SaveCardAsync(
                ...
                new Dictionary<string, object>()
                    .SetStartingProcessName(AbTestProcessHelper.ProcessName));
        }
                ...
                request: new CardSavingRequest(cardModifierActionAsync:
                    async (card, ct) =>
                    {
                        ...
                        queue.AddSignal(
                            ...
                            AbTestProcessHelper.TestSignal);
                    }));
        }
        ...
        public override Task InitializingGlobal(ITileGlobalExtensionContext context)
        {
            ...
            context.Workspace.LeftPanel.Tiles.AddRange(
                    new Tile(
                        "StartTestProcess",
                        TileHelper.SplitCaption("$AbTest_TestApprovalTile"),
                    ...
                    new Tile(
                        "SendTestSignal",
                        TileHelper.SplitCaption("$AbTest_TestSignalTile"),
