...
Используется для вывода в представлении.</Description>
	...
	<SchemePhysicalColumn ID="23c6e553-60d6-4b46-aa0b-5f0f1592d65b" Name="CanRestoreAllDeletedFiles" Type="Boolean Not Null">
		<Description>Восстановление всех удалённых файлов</Description>
		<SchemeDefaultConstraint IsPermanent="true" ID="c63929e8-df4c-497e-b4e2-018dac0333ed" Name="df_KrPermissions_CanRestoreAllDeletedFiles" Value="false" />
	</SchemePhysicalColumn>
	<SchemePhysicalColumn ID="4e0fb2d8-00c1-4912-b7ab-2da22a01f8cc" Name="CanCreateFileLink" Type="Boolean Not Null">
		<Description>Право на создание ссылки на скачивание файла/версии.
!ВАЖНО! Не следует менять название этого столбца, т.к. название столбца должно соответствовать названию флага рассчитываемых прав доступа + "Can"</Description>
		<SchemeDefaultConstraint IsPermanent="true" ID="c3df79ca-237e-40b4-a1b8-56f299b12c05" Name="df_KrPermissions_CanCreateFileLink" Value="false" />
	</SchemePhysicalColumn>
	<SchemePhysicalColumn ID="b33ace16-bbd9-4905-adca-baade5fead2f" Name="CanEditApprovalScheme" Type="Boolean Not Null">
		<Description>Может редактировать процесс согласования.</Description>
		<SchemeDefaultConstraint IsPermanent="true" ID="5d4a37b2-df0a-4a09-88be-1dbc6e124158" Name="df_KrPermissions_CanEditApprovalScheme" Value="false" />
	</SchemePhysicalColumn>
	<SchemePhysicalColumn ID="28600027-582b-46b0-bc7e-6f125146f667" Name="CanMentionNewUsers" Type="Boolean Not Null">
		<Description>Упоминание новых сотрудников в обсуждениях.</Description>
		<SchemeDefaultConstraint IsPermanent="true" ID="2e12dbe8-8127-48ab-8a4d-46a24b09422c" Name="df_KrPermissions_CanMentionNewUsers" Value="false" />
	</SchemePhysicalColumn>
