...
<SchemeTable Partition="bc3e1376-a8e1-4256-bf84-1bfc7a49c95f" ID="c44db46a-349f-45ec-b0ab-ec212c09b276" Name="SmartRoleGeneratorInfo" Group="Acl">
	...
	<SchemePhysicalColumn ID="94cde506-46f7-4ee0-a5ad-19cf552c4b27" Name="NextRequest" Type="BinaryJson Null">
		<Description>Следующий запрос, используемый для перерасчёта умных ролей.</Description>
	</SchemePhysicalColumn>
	<SchemePhysicalColumn ID="66d36f88-28e2-4c9c-83b5-2905c6f2a203" Name="NextRequestVersion" Type="Int32 Null">
		<Description>Номер версии генератора умных ролей, для которой был добавлен запрос на продолжение расчёта.</Description>
	</SchemePhysicalColumn>
