...
<SchemeTable Partition="bc3e1376-a8e1-4256-bf84-1bfc7a49c95f" ID="48dcb84f-1518-4de4-8995-86c4e75a1d03" Name="TaskConditionSettings" Group="Acl" IsVirtual="true" InstanceType="Cards" ContentType="Entries">
	...
	<SchemePhysicalColumn ID="ab25e38e-95be-43f6-b231-ad9b8fd3fc4d" Name="CheckTaskInProgress" Type="Boolean Not Null">
		<Description>Определяет, нужно ли проверять взятие в работу.</Description>
		<SchemeDefaultConstraint IsPermanent="true" ID="8703d0e4-6ad5-4d92-be90-9e036138d420" Name="df_TaskConditionSettings_CheckTaskInProgress" Value="false" />
	</SchemePhysicalColumn>
