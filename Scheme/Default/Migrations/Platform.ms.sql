...
BEGIN
    ...
    DECLARE @TimeZoneShortName nvarchar(20); SET @TimeZoneShortName = 'UTC+00:00';  
    DECLARE @TimeZoneUtcOffsetMinutes int; SET @TimeZoneUtcOffsetMinutes = 0;

    INSERT INTO [Instances] ([ID], [TypeID], [Version], [Created], [CreatedByID], [Modified], [ModifiedByID])
    VALUES (@ID, @InstanceTypeID, 1, @Modified, @ModifiedByID, @Modified, @ModifiedByID);
