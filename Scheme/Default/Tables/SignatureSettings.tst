...
<SchemeTable ID="076b2050-e20b-412b-942b-b4cb063e6941" Name="SignatureSettings" Group="System" InstanceType="Cards" ContentType="Entries">
	...
	<SchemePhysicalColumn ID="3a3e24b3-a557-4b10-ad5f-37449ad609d1" Name="SaveSignatureWithTemporaryErrors" Type="Boolean Null">
		<Description>Сохранять подпись при возвозможно временных ошибках</Description>
	</SchemePhysicalColumn>
	<SchemePhysicalColumn ID="eb787a99-f1ef-4868-ad82-24f6cf97dcec" Name="UseProxy" Type="Boolean Not Null">
		<Description>Использовать прокси.</Description>
		<SchemeDefaultConstraint IsPermanent="true" ID="00f2a25e-6b70-44f7-92d7-cc41de93e173" Name="df_SignatureSettings_UseProxy" Value="false" />
	</SchemePhysicalColumn>
	<SchemePhysicalColumn ID="9dce3b99-cbaf-45bd-9d70-0a123dc98f41" Name="ProxyAddress" Type="String(Max) Null">
		<Description>Адрес прокси.</Description>
	</SchemePhysicalColumn>
	<SchemePhysicalColumn ID="006d07a9-9174-43e1-96a5-ae7a24cc8e44" Name="ProxyLogin" Type="String(Max) Null">
		<Description>Логин для прокси.</Description>
	</SchemePhysicalColumn>
	<SchemePhysicalColumn ID="37eb1012-c0bd-47b7-995e-8330ad2e1088" Name="ProxyPassword" Type="String(Max) Null">
		<Description>Пароль для прокси.</Description>
	</SchemePhysicalColumn>
