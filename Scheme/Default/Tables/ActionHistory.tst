...
<SchemeTable ID="5089ca1c-27af-46e4-a2c2-af01bfd42e81" Name="ActionHistory" Group="System">
	...
	<SchemeComplexColumn ID="0bfbe64f-9ad9-4605-9af9-a057a04e58e9" Name="Type" Type="Reference(Typified) Not Null" ReferencedTable="b0538ece-8468-4d0b-8b4e-5a1d43e024db" WithForeignKey="false" NormalizationSourceID="35531951-3d12-4a93-b7f7-e9826a6e4875">
	...
	<SchemeComplexColumn ID="7e248939-8b75-41a4-80e0-1513da49b6e4" Name="ModifiedBy" Type="Reference(Typified) Not Null" ReferencedTable="6c977939-bbfc-456f-a133-f1c2244e3cc3" WithForeignKey="false" NormalizationSourceID="77e9c8bb-bb2f-4636-99df-c91a0c07c72c">
	...
	<SchemeComplexColumn ID="68b685f7-da03-4b8b-b527-a31bf6594064" Name="Session" Type="Reference(Typified) Null" ReferencedTable="bbd3d574-a33e-49fb-867d-db3c6811365e" WithForeignKey="false">
		<Description>Сессия (сессионный токен или токен доступа), в рамках которой выполнялось действие, или Null, если действие было выполнено вне пределов сессии
или в старых сборках платформы, не поддерживавших сессию в истории действий.</Description>
		<SchemeReferencingColumn IsSystem="true" IsPermanent="true" ID="68b685f7-da03-008b-4000-031bf6594064" Name="SessionID" Type="Guid Null" ReferencedColumn="5100aae0-3958-4b1a-b135-57b6640ced19">
			<Description>Идентификатор сессионного токена или токена доступа</Description>
		</SchemeReferencingColumn>
		<SchemePhysicalColumn ID="5b111283-2216-442e-82ff-57c3e13b3056" Name="SessionKind" Type="Int32 Null">
			<Description>Вид сессии (сессионного токена) или токена доступа, который представляет другой токен, используемый для доступа к системным ресурсам.
Может быть Null, если действие было выполнено вне пределов токена или в старых сборках платформы, не поддерживавших токены в истории действий.</Description>
		</SchemePhysicalColumn>
	</SchemeComplexColumn>
	<SchemeComplexColumn ID="2a42fb79-37af-49b5-a7cb-c94584e7b781" Name="Application" Type="Reference(Typified) Null" ReferencedTable="b939817b-bc1f-4a9d-87ef-694336870eed" WithForeignKey="false">
		<Description>Приложение, от имени которого выполняется действие.</Description>
	...
	<SchemePhysicalColumn ID="37a3950d-dfd9-47d6-be23-281d369408e9" Name="HostIP" Type="AnsiString(39) Null">
		<Description>IP-адрес устройства, с которого выполнено обращение к компонентам платформы.
 Длина достаточна для того, чтобы вместить IPv6 адрес.</Description>
	</SchemePhysicalColumn>
	<SchemePhysicalColumn ID="b015931c-83ad-4ab7-966d-b0b4922bc03b" Name="HostName" Type="String(128) Null">
		<Description>DNS-имя устройства, с которого выполнено обращение к компонентам платформы.</Description>
	</SchemePhysicalColumn>
