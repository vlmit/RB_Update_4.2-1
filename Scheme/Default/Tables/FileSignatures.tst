...
2 - подпись была создана в системе, User - пользователь, который осуществлял подписывание.</Description>
	...
	<SchemePhysicalColumn ID="4aea483b-869c-4f3e-8521-0287b63bb54e" Name="NearestCertValidTo" Type="Date Null">
		<Description>Ближайшая дата окончания срока действия сертификата из цепочки сертификатов.</Description>
	</SchemePhysicalColumn>
	<SchemePhysicalColumn ID="cbe7cd9c-3e11-4e9d-bc78-921101c6dde1" Name="NearestCertSerialNumber" Type="String(128) Null">
