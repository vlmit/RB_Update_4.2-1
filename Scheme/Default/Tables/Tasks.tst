...
<SchemeTable IsSystem="true" IsPermanent="true" ID="5bfa9936-bb5a-4e8f-89a9-180bfd8f75f8" Name="Tasks" Group="System" InstanceType="Cards" ContentType="Collections">
	...
	<SchemeComplexColumn IsSystem="true" IsPermanent="true" IsSealed="true" ID="5bfa9936-bb5a-008f-2000-080bfd8f75f8" Name="ID" Type="Reference(Typified) Not Null" ReferencedTable="1074eadd-21d7-4925-98c8-40d1e5f0ca0e" WithForeignKey="false">
	...
	<SchemeComplexColumn ID="c79ac778-a235-43de-b7ea-54285beefbb8" Name="AuthorTaskAssignedRole" Type="Reference(Typified) Null" ReferencedTable="2539f630-3898-457e-9e49-e1f87552caaf" WithForeignKey="false">
		<Description>RowID записи из TaskAssignedRoles, по которой был записан автор. Или null, если если автор был указан вручную.</Description>
		<SchemeReferencingColumn IsSystem="true" IsPermanent="true" ID="c79ac778-a235-00de-4000-04285beefbb8" Name="AuthorTaskAssignedRoleRowID" Type="Guid Null" ReferencedColumn="2539f630-3898-007e-3100-01f87552caaf" />
	</SchemeComplexColumn>
