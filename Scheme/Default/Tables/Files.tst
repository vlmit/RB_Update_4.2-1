...
<SchemeTable IsSystem="true" IsPermanent="true" ID="dd716146-b177-4920-bc90-b1196b16347c" Name="Files" Group="System" InstanceType="Cards" ContentType="Collections">
	...
	<SchemeComplexColumn IsSystem="true" IsPermanent="true" IsSealed="true" ID="dd716146-b177-0020-2000-01196b16347c" Name="ID" Type="Reference(Typified) Not Null" ReferencedTable="1074eadd-21d7-4925-98c8-40d1e5f0ca0e" WithForeignKey="false">
...
Если добавить внешний ключ в этой колонке, то также необходим индекс на неё, иначе при очень большом количестве файлов завершение/удаление любых заданий значительно замедляется.</Description>
	...
	<SchemeComplexColumn ID="e666c16c-49f8-44ee-91b7-80db766b46ba" Name="Type" Type="Reference(Typified) Not Null" ReferencedTable="b0538ece-8468-4d0b-8b4e-5a1d43e024db" WithForeignKey="false" NormalizationSourceID="35531951-3d12-4a93-b7f7-e9826a6e4875">
	...
	<SchemeComplexColumn ID="b1317e7c-59d9-4abd-8377-120a01ae2f11" Name="CreatedBy" Type="Reference(Typified) Not Null" ReferencedTable="6c977939-bbfc-456f-a133-f1c2244e3cc3" NormalizationSourceID="77e9c8bb-bb2f-4636-99df-c91a0c07c72c">
	...
	<SchemeComplexColumn ID="5b4badc7-fb8d-4f1d-8a40-d7dcdf6b1ccd" Name="ModifiedBy" Type="Reference(Typified) Not Null" ReferencedTable="6c977939-bbfc-456f-a133-f1c2244e3cc3" NormalizationSourceID="77e9c8bb-bb2f-4636-99df-c91a0c07c72c">
...
Колонка указывается без FK, т.к. файл, на который держится ссылка, может быть уже удалён.</Description>
		<SchemeReferencingColumn IsSystem="true" IsPermanent="true" ID="b231d370-31d8-0035-4000-08a76898ec1b" Name="OriginalFileID" Type="Guid Null" IsSparse="true" ReferencedColumn="dd716146-b177-0020-3100-01196b16347c" />
	</SchemeComplexColumn>
...
Колонка указывается без FK, т.к. файл, на версию которого держится ссылка, может быть уже удалён.</Description>
		<SchemeReferencingColumn IsSystem="true" IsPermanent="true" ID="966f4f00-f3f1-0014-4000-0a36b853d32c" Name="OriginalVersionRowID" Type="Guid Null" IsSparse="true" ReferencedColumn="e17fd270-5c61-00af-3100-0d6bb983f0d8" />
	</SchemeComplexColumn>
