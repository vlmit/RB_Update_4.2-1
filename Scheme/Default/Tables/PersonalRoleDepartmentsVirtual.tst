...
<SchemeTable ID="21566803-b822-42b2-ab11-2c20e72a0de4" Name="PersonalRoleDepartmentsVirtual" Group="Roles" IsVirtual="true" InstanceType="Cards" ContentType="Collections">
	...
	<SchemeComplexColumn ID="8e5beca9-e479-492e-b4d8-1e3ff242d83d" Name="Department" Type="Reference(Typified) Not Null" ReferencedTable="81f6010b-9641-4aa5-8897-b8e8603fbf4b">
		...
		<SchemePhysicalColumn ID="e16d5f7c-fd95-4ed7-acf5-279327269344" Name="DepartmentHeadUserID" Type="Guid Null">
			<Description>Идентификатор персональной роли пользователя, являющегося главой департамента</Description>
		</SchemePhysicalColumn>
		<SchemePhysicalColumn ID="dcaa1127-bf46-43c9-b625-fe31c22fc163" Name="DepartmentHeadUserName" Type="String(128) Null">
			<Description>Имя персональной роли пользователя, являющегося главой департамента</Description>
		</SchemePhysicalColumn>
	</SchemeComplexColumn>
