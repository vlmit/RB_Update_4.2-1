...
<SchemeTable Partition="dd8eeaba-9042-4fb5-9e8e-f7544463464f" ID="a99b285f-80c3-442a-85a6-2a3bfd645d2b" Name="WeDialogActionButtons" Group="WorkflowEngine" IsVirtual="true" InstanceType="Cards" ContentType="Collections">
	...
	<SchemePhysicalColumn ID="547beb2b-c8ca-4780-a62a-1b728bea1f49" Name="KeepFiles" Type="Boolean Not Null">
		<Description>Флаг "Сохранить файлы диалога по завершению". Позволяет сохранять файлы диалога в контексте выбранного варианта завершения диалога.</Description>
		<SchemeDefaultConstraint IsPermanent="true" ID="bc0eb900-a45f-4d9a-9ffb-f288e00c13e7" Name="df_WeDialogActionButtons_KeepFiles" Value="false" />
	</SchemePhysicalColumn>
