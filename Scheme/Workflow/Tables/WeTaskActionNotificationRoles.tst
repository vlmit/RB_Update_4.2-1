...
<SchemeTable Partition="dd8eeaba-9042-4fb5-9e8e-f7544463464f" ID="9b7fc0b0-da06-46df-a5c9-d66ecc386d55" Name="WeTaskActionNotificationRoles" Group="WorkflowEngine" IsVirtual="true" InstanceType="Cards" ContentType="Collections">
	...
	<SchemeComplexColumn ID="566b6444-770b-4ebb-8bd7-872b5b559410" Name="TaskNotification" Type="Reference(Typified) Null" ReferencedTable="9bfb39f5-2d15-4c23-82df-dcfaeb13fde4" IsReferenceToOwner="true" WithForeignKey="false">
		<Description>Ссылка на родительскую запись в WeTaskActionNotifications, в случае, когда указываем настройки уведомлений как таблицу</Description>
		<SchemeReferencingColumn IsSystem="true" IsPermanent="true" ID="566b6444-770b-00bb-4000-072b5b559410" Name="TaskNotificationRowID" Type="Guid Null" ReferencedColumn="9bfb39f5-2d15-0023-3100-0cfaeb13fde4" />
	</SchemeComplexColumn>
	<SchemeComplexColumn ID="4626a1f9-5c31-4203-a3df-36c0563460b0" Name="TaskCompletionNotifications" Type="Reference(Typified) Null" ReferencedTable="7d6ef28b-afc2-4de0-a34b-2ace26a88d2a" IsReferenceToOwner="true" WithForeignKey="false">
		<Description>Ссылка на родительскую запись в WeTaskActionCompletionNotifications</Description>
		<SchemeReferencingColumn IsSystem="true" IsPermanent="true" ID="4626a1f9-5c31-0003-4000-06c0563460b0" Name="TaskCompletionNotificationsRowID" Type="Guid Null" ReferencedColumn="7d6ef28b-afc2-00e0-3100-0ace26a88d2a" />
	</SchemeComplexColumn>
