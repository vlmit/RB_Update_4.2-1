...
<SchemeTable Partition="d1b372f3-7565-4309-9037-5e5a0969d94e" ID="0ad2b029-2f30-4e19-96df-bc3c2dcd9dfe" Name="KrSigningTaskOptions" Group="KrStageTypes" InstanceType="Tasks" ContentType="Entries">
	...
	<SchemePhysicalColumn ID="80ddf092-776a-42a0-b480-ad480b99d39e" Name="SignCardFiles" Type="Boolean Not Null">
		<Description>Признак того, что при завершении задания положительным решением будет произведено подписание файлов ЭП в карточке.</Description>
		<SchemeDefaultConstraint IsPermanent="true" ID="770091a9-311d-429a-9025-17f5f973a481" Name="df_KrSigningTaskOptions_SignCardFiles" Value="false" />
	</SchemePhysicalColumn>
