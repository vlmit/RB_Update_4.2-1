...
<SchemeTable Partition="d1b372f3-7565-4309-9037-5e5a0969d94e" ID="caac66aa-0cbb-4e2b-83fd-7c368e814d64" Name="KrSecondaryProcesses" Group="Kr" InstanceType="Cards" ContentType="Entries">
	...
	<SchemeComplexColumn ID="16e421a3-ae44-4307-b2fe-e3587b94bda2" Name="TileHandler" Type="Reference(Abstract) Null" WithForeignKey="false">
		<SchemeReferencingColumn IsSystem="true" IsPermanent="true" ID="16e421a3-ae44-0007-4000-03587b94bda2" Name="TileHandlerID" Type="Guid Null" ReferencedColumn="9a58123b-b2e9-4137-9c6c-5dab0ec02747" />
		<SchemePhysicalColumn ID="4188a905-8120-4909-a7f4-171cb38cd972" Name="TileHandlerName" Type="String(128) Null" />
	</SchemeComplexColumn>
	<SchemeComplexColumn ID="fca38637-242b-4b56-8b2d-fe36e37080d9" Name="ToolbarVisibilityMode" Type="Reference(Typified) Not Null" ReferencedTable="08dfa806-532d-462a-959f-5c864af55f02">
		<Description>Режим отображения на тулбаре</Description>
		<SchemeReferencingColumn IsSystem="true" IsPermanent="true" ID="fca38637-242b-0056-4000-0e36e37080d9" Name="ToolbarVisibilityModeID" Type="Int32 Not Null" ReferencedColumn="f516ae6d-c644-4a68-b4ca-20d162510516">
			<SchemeDefaultConstraint IsPermanent="true" ID="ae6726b1-227d-4d0e-90c4-a11e15f260fe" Name="df_KrSecondaryProcesses_ToolbarVisibilityModeID" Value="0" />
		</SchemeReferencingColumn>
		<SchemeReferencingColumn ID="f8f0ae6f-4acf-4abb-9ebf-d38b4eaa3e6c" Name="ToolbarVisibilityModeName" Type="String(Max) Not Null" ReferencedColumn="6d25a78b-9ae8-45e2-85e6-e45a2986725a">
			<SchemeDefaultConstraint IsPermanent="true" ID="10694ed4-17bc-4a58-977b-55022e20cac7" Name="df_KrSecondaryProcesses_ToolbarVisibilityModeName" Value="$WorkflowEngine_BusinessProcessButtonToolbarVisibilityModes_DoNotShowOnToolbar" />
		</SchemeReferencingColumn>
	</SchemeComplexColumn>
	<SchemePhysicalColumn ID="5afcde4d-d89d-4e20-97c2-8b7aaf446c83" Name="Alias" Type="String(Max) Null" />
	<SchemePhysicalColumn ID="b8f452bd-e7e8-4178-8ec1-01a3e5c7abc2" Name="Hidden" Type="Boolean Not Null">
		<SchemeDefaultConstraint IsPermanent="true" ID="35db6562-f117-4e79-840a-60d9e4e679af" Name="df_KrSecondaryProcesses_Hidden" Value="false" />
	</SchemePhysicalColumn>
