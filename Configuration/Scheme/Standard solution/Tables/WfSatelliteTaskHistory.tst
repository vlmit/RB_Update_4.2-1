...
RowID - идентификатор задания (он же идентификатор записи в истории заданий TaskHistory после того, как задание завершено).</Description>
	<SchemeComplexColumn IsSystem="true" IsPermanent="true" IsSealed="true" ID="cd241343-4eb1-005f-2000-09ff4cfa597e" Name="ID" Type="Reference(Typified) Not Null" ReferencedTable="1074eadd-21d7-4925-98c8-40d1e5f0ca0e" WithForeignKey="false">
