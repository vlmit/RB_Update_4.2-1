...
<SchemeTable Partition="d1b372f3-7565-4309-9037-5e5a0969d94e" ID="baaceebe-011d-4f1a-9431-00c4f8b233b9" Name="KrSigningActionVirtual" Group="KrWe" IsVirtual="true" InstanceType="Cards" ContentType="Entries">
	...
	<SchemePhysicalColumn ID="51e5fbb8-3753-4cd7-b6ad-70411c44bbb2" Name="NotCreateReturnEditTaskHistoryRecord" Type="Boolean Not Null">
		...
		<SchemeDefaultConstraint IsPermanent="true" ID="c5de653f-23e6-41f6-a3d4-9e55c75bc6aa" Name="df_KrSigningActionVirtual_NotCreateReturnEditTaskHistoryRecord" Value="false" />
	</SchemePhysicalColumn>
	<SchemePhysicalColumn ID="27f1832c-95e8-4610-9698-7644703d59aa" Name="SignCardFiles" Type="Boolean Not Null">
		<Description>Признак того, что при завершении задания необходимо подписать файл ЭП.</Description>
		<SchemeDefaultConstraint IsPermanent="true" ID="d7662dfe-14f5-4c5d-9bee-e84742f0d0fa" Name="df_KrSigningActionVirtual_SignCardFiles" Value="false" />
	</SchemePhysicalColumn>
	<SchemePhysicalColumn ID="29c35479-62dd-4484-907c-a2d428f0a2b9" Name="NoSignFilesDialog" Type="Boolean Not Null">
		<Description>Признак того, что диалог для выбора файла для подписания не будет отображён.</Description>
		<SchemeDefaultConstraint IsPermanent="true" ID="dabab7b5-d868-401d-96ec-804e44056f6c" Name="df_KrSigningActionVirtual_NoSignFilesDialog" Value="false" />
	</SchemePhysicalColumn>
	<SchemePhysicalColumn ID="d2fc2ef0-b1c4-4bcb-a14c-0efd8e124965" Name="DoNotSignFileCopies" Type="Boolean Not Null">
		<Description>Признак того, что копии файлов не будут подписаны ЭП.</Description>
		<SchemeDefaultConstraint IsPermanent="true" ID="ad5dfddc-611d-459e-8619-0050babd15e1" Name="df_KrSigningActionVirtual_DoNotSignFileCopies" Value="false" />
	</SchemePhysicalColumn>
	<SchemePhysicalColumn ID="a15c3705-3a62-458f-bd41-7807511fa711" Name="NoCommentDialog" Type="Boolean Not Null">
		<Description>Признак того, что диалог с комментарием к ЭП будет пропущен.</Description>
		<SchemeDefaultConstraint IsPermanent="true" ID="0b7c464d-62be-4576-9def-391273fe6577" Name="df_KrSigningActionVirtual_NoCommentDialog" Value="false" />
	</SchemePhysicalColumn>
