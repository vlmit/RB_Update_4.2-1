...
<SchemeTable Partition="d1b372f3-7565-4309-9037-5e5a0969d94e" ID="663dcabe-f9d8-4a52-a235-6c407e683810" Name="KrDialogStageTypeSettingsVirtual" Group="KrStageTypes" IsVirtual="true" InstanceType="Cards" ContentType="Entries">
	...
	<SchemePhysicalColumn ID="7ed4663f-94ff-49b6-a126-6413ce62bb09" Name="NotDisplayTabs" Type="Boolean Not Null">
		<Description>Признак, определяющий, нужно ли скрывать заголовки вкладок или нет.</Description>
		<SchemeDefaultConstraint IsPermanent="true" ID="3d9c0f8f-93c4-4e5f-89d8-d9d5643bf5e5" Name="df_KrDialogStageTypeSettingsVirtual_NotDisplayTabs" Value="false" />
	</SchemePhysicalColumn>
