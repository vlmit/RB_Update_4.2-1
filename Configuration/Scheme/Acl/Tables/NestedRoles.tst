...
<SchemeTable Partition="bc3e1376-a8e1-4256-bf84-1bfc7a49c95f" ID="312b1519-8079-44d7-a5b4-496db41da98c" Name="NestedRoles" Group="Acl" InstanceType="Cards" ContentType="Entries">
	...
	<SchemeComplexColumn ID="687534e2-d49e-4b51-b941-c16bd42c2ba0" Name="Context" Type="Reference(Abstract) Not Null" WithForeignKey="false">
		<SchemeReferencingColumn IsSystem="true" IsPermanent="true" ID="687534e2-d49e-0051-4000-016bd42c2ba0" Name="ContextID" Type="Guid Not Null" ReferencedColumn="9a58123b-b2e9-4137-9c6c-5dab0ec02747" />
		<SchemePhysicalColumn ID="8b60f42f-9213-4a36-9346-c3aebdc34fe9" Name="ContextName" Type="String(Max) Not Null" />
	</SchemeComplexColumn>
