...
или в старых сборках платформы, не поддерживавших сессию в истории действий.</Description>
		...
		<SchemePhysicalColumn ID="38c55671-02f1-4d9e-bd7d-3ae153cab1c2" Name="SessionKind" Type="Int32 Null">
...
Может быть Null, если действие было выполнено вне пределов токена или в старых сборках платформы, не поддерживавших токены в истории действий.</Description>
	...
	<SchemePhysicalColumn ID="d61dbb91-5b80-4fb5-aecc-b6c6c5173e82" Name="HostIP" Type="String(384) Null">
		<Description>IP-адрес устройства, с которого выполнено обращение к компонентам платформы.</Description>
	</SchemePhysicalColumn>
	<SchemePhysicalColumn ID="8f2cd730-b69c-4e90-a886-7842afb2f3ac" Name="HostName" Type="String(256) Not Null">
