...
<SchemeTable ID="ef4bbb91-4d48-4c68-9e05-34ab4d5c2b36" Name="FunctionRolesVirtual" Group="System" IsVirtual="true" InstanceType="Cards" ContentType="Entries">
	...
	<SchemePhysicalColumn ID="4979a67f-b005-4b25-8d42-6920d8640efa" Name="ShowInTaskDetails" Type="Boolean Not Null">
		<Description>По умолчанию устанавливать флаг "Отображать в задании" для всех записей с этой ФР.</Description>
		<SchemeDefaultConstraint IsPermanent="true" ID="3310ed54-0488-40d1-9e22-d2baa3b2325c" Name="df_FunctionRolesVirtual_ShowInTaskDetails" Value="false" />
	</SchemePhysicalColumn>
