...
Дата/время актуальны при расчёте времени действия паролей, по наступлению которого пароль требуется сменить.</Description>
	...
	<SchemePhysicalColumn ID="f95f9256-9ba9-41cd-bedf-0786a561e183" Name="InsuranceNumber" Type="String(20) Null">
		<Description>Номер СНИЛС</Description>
	</SchemePhysicalColumn>
	<SchemePhysicalColumn ID="1b16fbd3-42b2-4125-9100-28ef4094ec33" Name="Messengers" Type="String(Max) Null">
		<Description>Сериализованный список мессенджеров сотрудника</Description>
	</SchemePhysicalColumn>
