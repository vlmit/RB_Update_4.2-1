...
<SchemeTable ID="62fd7bdd-0fc1-4370-afd6-54ac7e5320b4" Name="PersonalRoleSatellite" Group="Roles" InstanceType="Cards" ContentType="Entries">
	...
	<SchemeComplexColumn IsSystem="true" IsPermanent="true" IsSealed="true" ID="62fd7bdd-0fc1-0070-2000-04ac7e5320b4" Name="ID" Type="Reference(Typified) Not Null" ReferencedTable="1074eadd-21d7-4925-98c8-40d1e5f0ca0e" WithForeignKey="false">
...
См. перечисление CardFilePreviewPosition в API.</Description>
	...
	<SchemePhysicalColumn ID="d28aaca1-b187-4df9-9781-d851e4207a1b" Name="SubscribeToAllTopics" Type="Boolean Not Null">
		<Description>Recieve notifications on all topics where I am a participant</Description>
		<SchemeDefaultConstraint IsPermanent="true" ID="1d35ec25-e255-4bdb-aa4c-a1d3409bae30" Name="df_PersonalRoleSatellite_SubscribeToAllTopics" Value="false" />
	</SchemePhysicalColumn>
	<SchemePhysicalColumn ID="6a404137-7c90-439b-84a4-a7b2bc9b0ff7" Name="TourFlags" Type="BinaryJson Null">
		<Description>Запись о пройденных или отложенных интерактивных обучениях. Ключ: название тура. Значение: флаг, где true - обучение завершено, false - обучение отложено. </Description>
	</SchemePhysicalColumn>
