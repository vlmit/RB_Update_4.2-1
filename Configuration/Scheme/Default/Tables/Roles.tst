...
<SchemeTable ID="81f6010b-9641-4aa5-8897-b8e8603fbf4b" Name="Roles" Group="Roles" InstanceType="Cards" ContentType="Entries">
	...
	<SchemePhysicalColumn ID="c1b7fb89-29b7-4336-84e9-23f651651552" Name="AdSyncDistinguishedName" Type="String(260) Null" />
	...
	<SchemePhysicalColumn ID="4cc896b0-b6fa-49a3-b25e-9c536138d5f9" Name="DeputiesExpired" Type="Date Not Null">
	...
	<SchemePhysicalColumn ID="5abec0d3-9fdc-4def-b638-5330fcf98029" Name="InheritCalendar" Type="Boolean Not Null">
		<Description>Наследовать календарь от родительской роли</Description>
		<SchemeDefaultConstraint IsPermanent="true" ID="92fe3cca-fe0f-49e4-942f-aab2aa9228cf" Name="df_Roles_InheritCalendar" Value="true" />
	</SchemePhysicalColumn>
	...
	<SchemeIndex ID="eb322333-9198-4102-8b57-475e2edfe530" Name="ndx_Roles_AdSyncDistinguishedName" IsUnique="true">
		<Predicate Dbms="SqlServer">[AdSyncDistinguishedName] IS NOT NULL</Predicate>
		<Predicate Dbms="PostgreSql">"AdSyncDistinguishedName" IS NOT NULL</Predicate>
		<SchemeIndexedColumn Column="c1b7fb89-29b7-4336-84e9-23f651651552" />
	</SchemeIndex>
</SchemeTable>