...
<SchemeTable Partition="dd8eeaba-9042-4fb5-9e8e-f7544463464f" ID="7c068441-e9e1-445a-a371-bf9436156428" Name="WeTaskActionDialogs" Group="WorkflowEngine" IsVirtual="true" InstanceType="Cards" ContentType="Collections">
	...
	<SchemePhysicalColumn ID="da3c374f-7341-482b-95f3-47a27d05dafa" Name="NotDisplayTabs" Type="Boolean Not Null">
		<Description>Признак, определяющий, нужно ли скрывать заголовки вкладок или нет.</Description>
		<SchemeDefaultConstraint IsPermanent="true" ID="4441e2d9-0678-493a-ac47-a3c1778c1eb1" Name="df_WeTaskActionDialogs_NotDisplayTabs" Value="false" />
	</SchemePhysicalColumn>
