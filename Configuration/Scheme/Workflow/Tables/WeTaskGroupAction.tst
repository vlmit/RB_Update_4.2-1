...
<SchemeTable Partition="dd8eeaba-9042-4fb5-9e8e-f7544463464f" ID="915d8549-af3d-4d44-84a1-cef16ed89941" Name="WeTaskGroupAction" Group="WorkflowEngine" IsVirtual="true" InstanceType="Cards" ContentType="Entries">
	...
	<SchemeComplexColumn ID="88eb6487-9fd1-4e8d-91be-e80bc8cc4fdf" Name="TaskRole" Type="Reference(Typified) Not Null" ReferencedTable="a59078ce-8acf-4c45-a49a-503fa88a0580">
		<Description>Функциональная роль</Description>
		<SchemeReferencingColumn IsSystem="true" IsPermanent="true" ID="88eb6487-9fd1-008d-4000-080bc8cc4fdf" Name="TaskRoleID" Type="Guid Not Null" ReferencedColumn="bd4fdcea-8042-488a-94c9-770b49357cfe" />
		<SchemeReferencingColumn ID="2267a2d3-ddc0-45f5-893f-f84038e98dcb" Name="TaskRoleCaption" Type="String(128) Not Null" ReferencedColumn="f8b3afc6-cea7-4a98-b907-e716e0a426c6" />
	</SchemeComplexColumn>
	<SchemePhysicalColumn ID="9d68a7a6-9a85-4215-a0d6-1b9bdfc925b3" Name="Master" Type="Boolean Not Null">
		<Description>Основная запись. Опираясь на неё берётся временная зона и календарь.</Description>
		<SchemeDefaultConstraint IsPermanent="true" ID="42145691-a460-4327-a2bd-5055b05809d4" Name="df_WeTaskGroupAction_Master" Value="false" />
	</SchemePhysicalColumn>
	<SchemePhysicalColumn ID="ac099aae-2db1-43c8-88f5-c5495e2eeb69" Name="ShowInTaskDetails" Type="Boolean Not Null">
		<Description>Показывать запись в информации о задании.</Description>
		<SchemeDefaultConstraint IsPermanent="true" ID="97d715a7-79bd-44ba-b249-d35c3a10a596" Name="df_WeTaskGroupAction_ShowInTaskDetails" Value="false" />
	</SchemePhysicalColumn>
