...
<SchemeTable Partition="dd8eeaba-9042-4fb5-9e8e-f7544463464f" ID="59bf0d0b-f7fc-41d3-92da-56c673f1e0b3" Name="BusinessProcessButtons" Group="WorkflowEngine" InstanceType="Cards" ContentType="Collections">
	...
	<SchemeComplexColumn ID="46591bce-6cb4-4243-9965-50aa0abe3237" Name="ToolbarVisibilityMode" Type="Reference(Typified) Not Null" ReferencedTable="08dfa806-532d-462a-959f-5c864af55f02">
		<Description>Режим отображения на тулбаре</Description>
		<SchemeReferencingColumn IsSystem="true" IsPermanent="true" ID="46591bce-6cb4-0043-4000-00aa0abe3237" Name="ToolbarVisibilityModeID" Type="Int32 Not Null" ReferencedColumn="f516ae6d-c644-4a68-b4ca-20d162510516">
			<SchemeDefaultConstraint IsPermanent="true" ID="e278e949-dad9-41a8-9e05-3c063ee21bb6" Name="df_BusinessProcessButtons_ToolbarVisibilityModeID" Value="0" />
		</SchemeReferencingColumn>
		<SchemeReferencingColumn ID="294d8b76-4a82-4d10-8acd-0216ed957532" Name="ToolbarVisibilityModeName" Type="String(Max) Not Null" ReferencedColumn="6d25a78b-9ae8-45e2-85e6-e45a2986725a">
			<SchemeDefaultConstraint IsPermanent="true" ID="b528d25b-0f6f-416c-a8f8-e9c011e1b6dd" Name="df_BusinessProcessButtons_ToolbarVisibilityModeName" Value="$WorkflowEngine_BusinessProcessButtonToolbarVisibilityModes_DoNotShowOnToolbar" />
		</SchemeReferencingColumn>
	</SchemeComplexColumn>
	<SchemePhysicalColumn ID="eb244d5f-761b-4e44-bc41-0d4da4aa6b89" Name="AllowedVersions" Type="String(Max) Null" />
	<SchemePhysicalColumn ID="dba72201-521a-4280-b856-0cfd95c3552e" Name="Alias" Type="String(Max) Not Null">
		<SchemeDefaultConstraint IsPermanent="true" ID="b7740958-b20a-4d22-9d2a-a545318764ed" Name="df_BusinessProcessButtons_Alias" Value="" />
	</SchemePhysicalColumn>
	<SchemePhysicalColumn ID="fa6dc22f-54d1-439f-8a5a-f3dfcc3c7824" Name="Hidden" Type="Boolean Not Null">
		<SchemeDefaultConstraint IsPermanent="true" ID="2f6fd5cb-238a-4a1f-9c69-23d64832e584" Name="df_BusinessProcessButtons_Hidden" Value="false" />
	</SchemePhysicalColumn>
	<SchemeComplexColumn ID="d8e36488-a83e-4fe6-ae91-483478494d5a" Name="TileHandler" Type="Reference(Abstract) Null" WithForeignKey="false">
		<SchemeReferencingColumn IsSystem="true" IsPermanent="true" ID="d8e36488-a83e-00e6-4000-083478494d5a" Name="TileHandlerID" Type="Guid Null" ReferencedColumn="9a58123b-b2e9-4137-9c6c-5dab0ec02747" />
		<SchemePhysicalColumn ID="117a28a6-8cd8-49b5-aeaa-2c888784d00e" Name="TileHandlerName" Type="String(128) Null" />
	</SchemeComplexColumn>
