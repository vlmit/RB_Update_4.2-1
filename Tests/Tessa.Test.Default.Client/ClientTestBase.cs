...
namespace Tessa.Test.Default.Client
{
        ...
        TestBase
    {
        ...
        {
            PersonalRoleTestHelper.AssertPersonalRole(card, sessionUserID, role);
        ...
        /// </summary>
        /// <param name="resourceDirName">Путь к файлу в ресурсах манифеста относительно сборки <see cref="IResourceAssemblyManager.ResourceAssembly"/>.</param>
        ...
        protected override async ValueTask InitializeContainerAsync(IUnityContainer container)
        {
            ...
            container
                ...
                .RegisterClientTestDependencies(this.ResourceAssembly);
        }
        ...
        protected virtual ValueTask<IUnityContainer> InitializeClientContainerBaseAsync(
            ...
            CancellationToken cancellationToken = default)
        {
            unityContainer.RegisterClientForConsole(baseAddress: baseAddress);

            if (!unityContainer.IsRegistered<IConsoleLogger>())
            {
                unityContainer.RegisterConsoleOperationLogger(TextWriter.Null, TextWriter.Null, quiet: true);
            }
            ...
            CancellationToken cancellationToken = default)
        {
            ...
            await unityContainer
                .RegisterInstance(dbScope
                    ?? Platform.Data.DbScope.CreateDefault(
            ...
            var actualFoldersList = await unityContainer.FindAndRegisterExtensionsOnClientAsync(
                RegistratorTag.ClientOther, cancellationToken: cancellationToken);
        ...
        protected async Task<IAsyncDisposable> OpenSessionAsync(
            ...
            CancellationToken cancellationToken = default)
        {
            ThrowIfNullOrEmpty(login);
            cancellationToken.ThrowIfCancellationRequested();

            var outerUnityContainer = this.UnityContainer;
            var scope = new TestSessionScope(outerUnityContainer);
            ...
            try
            {
                ...
                await this.OpenSessionCoreAsync(login, password ?? login, cancellationToken);
                cancellationToken.ThrowIfCancellationRequested();
        ...
        /// <summary>
        /// Opens default session.
        /// </summary>
        /// <param name="cancellationToken"><inheritdoc cref="CancellationToken" path="/summary"/></param>
        /// <returns></returns>
        protected virtual Task OpenSessionCoreAsync(
            CancellationToken cancellationToken = default) =>
        ...
        /// <summary>
        /// Opens session with given credentials.
        /// </summary>
        /// <param name="userName">User name.</param>
        /// <param name="password">Password.</param>
        /// <param name="cancellationToken"><inheritdoc cref="CancellationToken" path="/summary"/></param>
        protected virtual async Task OpenSessionCoreAsync(
            string userName,
            string password,
            CancellationToken cancellationToken = default)
        {
