...
namespace Tessa.Test.Default.Server.Workflow
{
    ...
    public abstract class WeScenarioTestBase : WeTestBase
    {
        ...
        public Task ScenarioTestAsync(
            ...
            Func<WorkflowEngineCompiledBase, ValueTask>? initProcessMethodAsync = null,
            Func<CardLifecycleCompanion, CancellationToken, ValueTask>? initCardMethodAsync = null,
            bool isProcessAlive = default,
            CancellationToken cancellationToken = default)
        {
            return this.ScenarioTestAsync(
            ...
            CancellationToken cancellationToken = default)
        {
            ...
            var processInstanceCompanion = cardCompanion
            ...
            Assert.That(
                ...
                Is.EqualTo(isProcessAlive),
                $"Process has been {(isProcessAlive ? "alive" : "completed")}.");
        }
