...
namespace Tessa.Test.Default.Shared
{
    ...
    public interface IFixtureNameProvider
    {
        ...
        /// </summary>
        /// <param name="forThis">Вернуть имя для текущего класса.</param>
        /// <param name="cancellationToken">Объект, посредством которого можно отменить асинхронную задачу.</param>
        /// <returns>Имя ресурса.</returns>
        ValueTask<string> GetNextRandomFixtureNameAsync(bool forThis = false, CancellationToken cancellationToken = default);
