...
namespace Tessa.Test.Default.Shared.Platform.Storage
{
        ...
        TestActionAttribute
    {
        ...
        public override void BeforeTest(ITest test)
        {
            ...
            testActions.GetTestActions(ActionStage.BeforeSetUp).Add(new TestAction(test, this.BeforeSetUpAsync));
            testActions.GetTestActions(ActionStage.AfterTearDown).Add(new TestAction(test, AfterTearDownAsync));
        }
        ...
        private ValueTask BeforeSetUpAsync(object sender)
        {
            ...
            {
                var factory = this.SerializableObjectFactory;
                container.SerializableObjectFactory = factory;

                var serializableObject = factory.CreateSerializableObject();
