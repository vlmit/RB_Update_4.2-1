...
namespace Tessa.Test.Default.Shared.Kr
{
    ...
    public static class PermissionsConfiguratorExtensions
    {
        ...
        public static PermissionsConfigurator UseExtendedPermissions(
            ...
            int priority = 0)
        {
            ThrowIfNull(permissionsConfigurator);
        ...
        /// <param name="fileCheckRule">Проверять доступ к собственным файлам.</param>
        /// <param name="readAccessSetting">Доступ на чтение.</param>
        /// <param name="editAccessSetting">Доступ на редактирование.</param>
        /// <param name="createLinkAccessSetting">Доступ на создание ссылки.</param>
        ...
        /// <param name="maxCount">Допустимое количество файлов.</param>
        /// <param name="mandatory">Обязательный файл.</param>
        /// <returns>Текущий конфигуратор правила доступа.</returns>
        public static PermissionsConfigurator AddFileExtendedPermission(
            ...
            int? createLinkAccessSetting = null,
            ...
            bool mandatory = false)
        {
            ...
            permissionsConfigurator.ModifyCard((_, clc, ct) =>
            {
                ...
                newRow.Fields["CreateLinkAccessSettingID"] = Int32Boxes.Box(createLinkAccessSetting);
                newRow.Fields["CreateLinkAccessSettingName"] = createLinkAccessSetting?.ToString();
                ...
                newRow.Fields["FileSizeLimit"] = Int32Boxes.Box(fileSizeLimit);
                newRow.Fields["MaxCount"] = Int32Boxes.Box(maxCount);
                newRow.Fields["Mandatory"] = BooleanBoxes.Box(mandatory);
            ...
            int? fileSizeLimit = null)
        {
            ...
            permissionsConfigurator.ModifyCard((_, clc, ct) =>
            {
                ...
                row.Fields["CreateLinkAccessSettingID"] = Int32Boxes.Box(createLinkAccessSetting);
                row.Fields["CreateLinkAccessSettingName"] = createLinkAccessSetting?.ToString();
