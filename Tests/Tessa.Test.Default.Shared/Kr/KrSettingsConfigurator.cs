...
{
    /// <summary>
    /// Предоставляет методы, выполняющие настройку параметров типового решения (Настройки -&gt; Типовое решение).
    /// </summary>
        ...
        IConfiguratorScopeManager<TestConfigurationBuilder>
    {
        ...
        {
            return this.AddRow(
                KrConstants.KrSettingsRouteExtraTaskTypes.Name,
                KrConstants.KrSettingsRouteExtraTaskTypes.TaskTypeID,
                KrConstants.KrSettingsRouteExtraTaskTypes.TaskTypeName,
                KrConstants.KrSettingsRouteExtraTaskTypes.TaskTypeCaption,
                taskTypeID,
                taskTypeName,
                taskTypeCaption);
        }
        ...
        public KrSettingsConfigurator SetAclReadCardAccess(
            ...
            this.SetValue("KrSettings", "AclReadCardAccess", BooleanBoxes.Box(aclReadCardAccess));
