...
namespace Tessa.Test.Default.Shared.Kr.Routes
{
        ...
        ICardLifecycleCompanion<KrRouteProcessInstanceLifecycleCompanion>
    {
        ...
        /// <summary>
        /// Идентификатор экземпляра процесса или значение <see langword="null"/>, если выполняется взаимодействие не по идентификатору экземпляра процесса, например, отправка глобального сигнала.
        /// </summary>
        ...
        /// <inheritdoc/>
        public KrRouteProcessInstanceLifecycleCompanion Export(Action<CardGetRequest> modifyRequestAction = null)
        {
        ...
        /// <inheritdoc/>
        public void AddPendingAction(IPendingAction pendingAction, bool reverseOrder = false) =>
            this.cardLifecycle.AddPendingAction(pendingAction, reverseOrder);
        ...
        /// <inheritdoc/>
        public int RemovePendingAction(Predicate<IPendingAction> match) =>
            this.cardLifecycle.RemovePendingAction(match);
