...
namespace Tessa.Test.Default.Shared.Kr
{
    ...
    /// Данный конфигуратор предназначен только для внутреннего использования. Для конфигурирования типов карточек используйте возвращаемое значение метода
    /// <see cref="KrSettingsConfigurator.GetCardTypeConfigurator(Guid)"/>.
    /// </summary>
        ...
        ITypeConfigurator<KrSettingsTypeConfigurator>
    {
        ...
        {
            ThrowIfNull(krSettingsConfigurator);
