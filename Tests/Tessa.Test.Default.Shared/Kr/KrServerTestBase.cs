...
namespace Tessa.Test.Default.Shared.Kr
{
        ...
        IImportObjects
    {
        ...
        /// <summary>
        /// Делагат для загрузки карточки с сервера с указанием клиента в качестве типа сервиса.
        /// </summary>
        public static Action<CardGetRequest> GetCardWithClientServiceType =
            (request) => request.ServiceType = CardServiceType.Client;
        ...
        /// <inheritdoc/>
        public virtual bool IsImportCardsWithFiles => true;
        ...
        public virtual async Task ImportCardsAsync()
        {
            await this.TestConfigurationBuilder
                ...
                .InitializeDefaultCalendar(this.ResourceAssembly)
            ...
            await this.TestConfigurationBuilder
                ...
                .If(this.IsImportCardsWithFiles, c => c.ImportCardsWithFilesCardLib(this.ImportCardsWithFilesCardLibPredicateAsync))
                .GoAsync()
                ;
        }
        ...
        /// <inheritdoc/>
        public virtual ValueTask<bool> ImportCardsWithFilesCardLibPredicateAsync(Card card, CancellationToken cancellationToken = default) =>
