...
namespace Tessa.Test.Default.Shared.Web
{
        ...
        IAsyncDisposable
    {
        ...
        /// <summary>
        /// Возвращает объект содержащий параметры используемые при создании <see cref="HttpClient"/>
        /// в методе <see cref="CreateClient(WebApplicationFactoryClientOptions)"/>.
        /// </summary>
        ...
        ValueTask InitializeAndStartAsync();
