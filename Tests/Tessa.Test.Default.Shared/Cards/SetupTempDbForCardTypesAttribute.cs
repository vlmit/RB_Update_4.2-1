...
namespace Tessa.Test.Default.Shared.Cards
{
        ...
        SetupTempDbAttribute
    {
        ...
        public SetupTempDbForCardTypesAttribute(
            ...
            : base(dbms, configurationString, testScriptFileNames) =>
            this.cardTypeRepositoryFactoryType = typeof(DefaultCardTypeRepositoryFactory);
        ...
        public override void BeforeTest(ITest test)
        {
            ...
            testActions.GetTestActions(ActionStage.AfterOneTimeTearDown).Add(new TestAction(test, AfterOneTimeTearDownAsync));
        }
        ...
        private ValueTask BeforeInitializeAsync(object sender)
        {
            ...
            {
                var repository = this.CardTypeRepositoryFactory.Create(container.DbScope);
